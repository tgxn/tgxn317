...
final class Animable_Sub4 extends Animable {
    ...
    public final Model getRotatedModel() {
        ...
        if (aSpotAnim_1592.aClass20_407 != null) {
            j = aSpotAnim_1592.aClass20_407.animationFrames[anInt1593];
        }
        ...
        if (aSpotAnim_1592.anInt410 != 128 || aSpotAnim_1592.anInt411 != 128) {
            class30_sub2_sub4_sub6_1.scaleT(aSpotAnim_1592.anInt410, aSpotAnim_1592.anInt410, aSpotAnim_1592.anInt411);
        }
    ...
    public final void method456(int i, int j) {
        ...
        if (aSpotAnim_1592.aClass20_407 != null) {
            for (anInt1594 += i; anInt1594 > aSpotAnim_1592.aClass20_407.getAnimationDelay(anInt1593);) {
                anInt1594 -= aSpotAnim_1592.aClass20_407.getAnimationDelay(anInt1593) + 1;
                anInt1593++;
                if (anInt1593 >= aSpotAnim_1592.aClass20_407.frameCount) {
                    anInt1593 = 0;
                }
            }
        }
