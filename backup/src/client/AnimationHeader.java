...
public class AnimationHeader {
    ...
    private static AnimationHeader aClass36Array635[];
    public int anInt636;
    ...
    public static void method528(int i) {
        aClass36Array635 = new AnimationHeader[i + 1];
    ...
    public static void method529(byte abyte0[]) {
        ...
        i1 += i + 2;
        Packet class30_sub2_sub2_2 = new Packet(abyte0);
        class30_sub2_sub2_2.currentOffset = i1;
        i1 += j;
        Packet class30_sub2_sub2_3 = new Packet(abyte0);
        class30_sub2_sub2_3.currentOffset = i1;
        i1 += k;
        Packet class30_sub2_sub2_4 = new Packet(abyte0);
        class30_sub2_sub2_4.currentOffset = i1;
        i1 += l;
        Packet class30_sub2_sub2_5 = new Packet(abyte0);
        ...
        for (int l1 = 0; l1 < k1; l1++) {
            ...
            AnimationHeader class36 = aClass36Array635[i2] = new AnimationHeader();
    ...
    public static AnimationHeader method531(int j) {
