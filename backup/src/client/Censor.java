...
public final class Censor {
    ...
    public static void loadConfig(JagexArchive class44) {
        Packet class30_sub2_sub2 = new Packet(class44.getDataForName("fragmentsenc.txt"));
        Packet class30_sub2_sub2_1 = new Packet(class44.getDataForName("badenc.txt"));
        Packet class30_sub2_sub2_2 = new Packet(class44.getDataForName("domainenc.txt"));
        Packet class30_sub2_sub2_3 = new Packet(class44.getDataForName("tldlist.txt"));
        readValues(class30_sub2_sub2, class30_sub2_sub2_1, class30_sub2_sub2_2, class30_sub2_sub2_3);
    }

    private static void readValues(Packet class30_sub2_sub2, Packet class30_sub2_sub2_1, Packet class30_sub2_sub2_2, Packet class30_sub2_sub2_3) {
