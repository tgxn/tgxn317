...
final class ItemDef {
    ...
    public static final void unpackConfig(JagexArchive streamLoader) {
        stream = new Packet(streamLoader.getDataForName("obj.dat"));
        Packet stream1 = new Packet(streamLoader.getDataForName("obj.idx"));
    ...
    public static final Sprite getSprite(int i, int j, int k, int l) {
        ...
        int k1 = Jagex3DCanvas.textureInt1;
        int l1 = Jagex3DCanvas.textureInt2;
        int ai[] = Jagex3DCanvas.anIntArray1472;
        ...
        int l3 = Jagex3DCanvas.anIntArray1470[class8.modelRotation1] * k3 >> 16;
        int i4 = Jagex3DCanvas.anIntArray1471[class8.modelRotation1] * k3 >> 16;
        ...
        if (k == 0) {
            mruNodes1.removeFromCache(class30_sub2_sub1_sub1_1, i);
        }
        DrawingArea.initDrawingArea(j2, i2, ai1);
        DrawingArea.createDrawingArea(k2, i3, l2, j3);
        Jagex3DCanvas.textureInt1 = k1;
        Jagex3DCanvas.textureInt2 = l1;
        Jagex3DCanvas.anIntArray1472 = ai;
        Jagex3DCanvas.aBoolean1464 = true;
        if (l < 9 || l > 9) {
    ...
    public final Model method201(int i) {
        ...
        mruNodes2.removeFromCache(class30_sub2_sub4_sub6, id);
        return class30_sub2_sub4_sub6;
    }
    ...
    public final void readValues(Packet stream) {
        do {
