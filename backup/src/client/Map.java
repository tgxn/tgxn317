...
final class Map {
    ...
    public Map(byte abyte0[][][], int i, int j, int k, int ai[][][]) {
        aBoolean132 = true;
        aBoolean143 = false;
        anInt150 = -53;
        anInt145 = 99;
    ...
    public final void method171(MapRegion aclass11[], WorldController class25, int i) {
        for (int j = 0; j < 4; j++) {
            for (int k = 0; k < 104; k++) {
            ...
            for (int l6 = -5; l6 < anInt146 + 5; l6++) {
                for (int i8 = 0; i8 < anInt147; i8++) {
                    ...
                    if (k9 >= 0 && k9 < anInt146) {
                        ...
                        if (l12 > 0) {
                            Flo class22 = Flo.floorCache[l12 - 1];
                            anIntArray124[i8] += class22.anInt397;
                            anIntArray125[i8] += class22.groundHue;
                            anIntArray126[i8] += class22.groundLuminosity;
                    ...
                    if (i13 >= 0 && i13 < anInt146) {
                        ...
                        if (i14 > 0) {
                            Flo class22_1 = Flo.floorCache[i14 - 1];
                            anIntArray124[i8] -= class22_1.anInt397;
                            anIntArray125[i8] -= class22_1.groundHue;
                            anIntArray126[i8] -= class22_1.groundLuminosity;
                ...
                if (l6 >= 1 && l6 < anInt146 - 1) {
                    ...
                    for (int k17 = -5; k17 < anInt147 + 5; k17++) {
                        ...
                        if (k17 >= 1 && k17 < anInt147 - 1 && (!lowMem || (aByteArrayArrayArray149[0][l6][k17] & 2) != 0 || (aByteArrayArrayArray149[l][l6][k17] & 0x10) == 0 && method182(k17, l, l6, 0) == anInt131)) {
                            if (l < anInt145) {
                                anInt145 = l;
                            }
                            ...
                            if (l18 > 0 || i19 > 0) {
                                ...
                                if (l > 0) {
                                    ...
                                    if (i19 > 0 && !Flo.floorCache[i19 - 1].aBoolean393) {
                                        flag = false;
                                    }
                                ...
                                int i22 = 0;
                                if (j21 != -1) {
                                    i22 = Jagex3DCanvas.anIntArray1482[method187(k21, 96)];
                                }
                                if (i19 == 0) {
                                    ...
                                    Flo class22_2 = Flo.floorCache[i19 - 1];
                                    int i23 = class22_2.groundTexture;
                                    int j23;
                                    int k23;
                                    if (i23 >= 0) {
                                        k23 = Jagex3DCanvas.method369(i23);
                                        j23 = -1;
                                    } else if (class22_2.groundColor == 0xff00ff) {
                                        k23 = 0;
                                        j23 = -2;
                                        i23 = -1;
                                    } else {
                                        j23 = method177(class22_2.groundSaturation, class22_2.groundHue, class22_2.groundLuminosity);
                                        k23 = Jagex3DCanvas.anIntArray1482[method185(class22_2.mapColor, 96)];
                                    }
    ...
    public static final void method173(byte byte0, Packet class30_sub2_sub2, OnDemandFetcher class42_sub1) {
        label0:
        {
            int i = -1;
            if (byte0 != -107) {
    ...
    private final void method175(int i, WorldController class25, MapRegion class11, int j, int k, int l, int i1,
            boolean flag, int j1) {
        ...
        if (j == 22) {
            ...
            if (class46.anInt781 == -1 && class46.childrenIDs == null) {
                ...
                obj = new AnimableObject(i1, j1, 22, l1, (byte) 7, i2, k1, j2, class46.anInt781, true);
            }
            class25.method280(k, k2, i, ((Animable) (obj)), byte0, l2, l);
        ...
        if (j == 10 || j == 11) {
            ...
            if (class46.anInt781 == -1 && class46.childrenIDs == null) {
                ...
                obj1 = new AnimableObject(i1, j1, 10, l1, (byte) 7, i2, k1, j2, class46.anInt781, true);
            }
            if (obj1 != null) {
                int i5 = 0;
                if (j == 11) {
                ...
                int l4;
                if (j1 == 1 || j1 == 3) {
                    j4 = class46.objectHeight;
                    l4 = class46.objectWidth;
                } else {
                    j4 = class46.objectWidth;
                    l4 = class46.objectHeight;
                }
                if (class25.method284(l2, k2, l4, ((Animable) (obj1)), j4, k, i5, (byte) 110, i, l) && class46.aBoolean779) {
                    Model class30_sub2_sub4_sub6;
                    if (obj1 instanceof Model) {
                        class30_sub2_sub4_sub6 = (Model) obj1;
                    } else {
            ...
            if (class46.aBoolean767 && class11 != null) {
                class11.method212(class46.aBoolean757, class46.objectWidth, class46.objectHeight, l, i, j1);
            }
            return;
        }
        if (j >= 12) {
            ...
            if (class46.anInt781 == -1 && class46.childrenIDs == null) {
                ...
                obj2 = new AnimableObject(i1, j1, j, l1, (byte) 7, i2, k1, j2, class46.anInt781, true);
            }
            class25.method284(l2, k2, 1, ((Animable) (obj2)), 1, k, 0, (byte) 110, i, l);
        ...
        if (j == 0) {
            ...
            if (class46.anInt781 == -1 && class46.childrenIDs == null) {
                ...
                obj3 = new AnimableObject(i1, j1, 0, l1, (byte) 7, i2, k1, j2, class46.anInt781, true);
            }
            class25.method282(anIntArray152[j1], ((Animable) (obj3)), true, l2, i, byte0, l, null, k2, 0, k);
            if (j1 == 0) {
            ...
            if (class46.anInt775 != 16) {
                class25.method290(i, class46.anInt775, l, k);
            }
            return;
        }
        if (j == 1) {
            ...
            if (class46.anInt781 == -1 && class46.childrenIDs == null) {
                ...
                obj4 = new AnimableObject(i1, j1, 1, l1, (byte) 7, i2, k1, j2, class46.anInt781, true);
            }
            class25.method282(anIntArray140[j1], ((Animable) (obj4)), true, l2, i, byte0, l, null, k2, 0, k);
            if (class46.aBoolean779) {
                if (j1 == 0) {
                    aByteArrayArrayArray134[k][l][i + 1] = 50;
                } else if (j1 == 1) {
        ...
        if (j == 2) {
            ...
            if (class46.anInt781 == -1 && class46.childrenIDs == null) {
                ...
                obj11 = new AnimableObject(i1, 4 + j1, 2, l1, (byte) 7, i2, k1, j2, class46.anInt781, true);
                obj12 = new AnimableObject(i1, i3, 2, l1, (byte) 7, i2, k1, j2, class46.anInt781, true);
            }
            class25.method282(anIntArray152[j1], ((Animable) (obj11)), true, l2, i, byte0, l, ((Animable) (obj12)), k2, anIntArray152[i3], k);
            if (class46.aBoolean764) {
                if (j1 == 0) {
                    anIntArrayArrayArray135[k][l][i] |= 0x249;
                    anIntArrayArrayArray135[k][l][i + 1] |= 0x492;
        ...
        if (j == 3) {
            ...
            if (class46.anInt781 == -1 && class46.childrenIDs == null) {
                ...
                obj5 = new AnimableObject(i1, j1, 3, l1, (byte) 7, i2, k1, j2, class46.anInt781, true);
            }
            class25.method282(anIntArray140[j1], ((Animable) (obj5)), true, l2, i, byte0, l, null, k2, 0, k);
            if (class46.aBoolean779) {
                if (j1 == 0) {
                    aByteArrayArrayArray134[k][l][i + 1] = 50;
                } else if (j1 == 1) {
        ...
        if (j == 9) {
            ...
            if (class46.anInt781 == -1 && class46.childrenIDs == null) {
                ...
                obj6 = new AnimableObject(i1, j1, j, l1, (byte) 7, i2, k1, j2, class46.anInt781, true);
            }
            class25.method284(l2, k2, 1, ((Animable) (obj6)), 1, k, 0, (byte) 110, i, l);
            if (class46.aBoolean767 && class11 != null) {
                class11.method212(class46.aBoolean757, class46.objectWidth, class46.objectHeight, l, i, j1);
            }
            return;
        ...
        if (j == 4) {
            ...
            if (class46.anInt781 == -1 && class46.childrenIDs == null) {
                ...
                obj7 = new AnimableObject(i1, 0, 4, l1, (byte) 7, i2, k1, j2, class46.anInt781, true);
            }
            class25.method283(l2, i, j1 * 512, k, 0, k2, ((Animable) (obj7)), l, byte0, 0, anIntArray152[j1]);
            return;
        }
        if (j == 5) {
            int i4 = 16;
            ...
            if (class46.anInt781 == -1 && class46.childrenIDs == null) {
                ...
                obj13 = new AnimableObject(i1, 0, 4, l1, (byte) 7, i2, k1, j2, class46.anInt781, true);
            }
            class25.method283(l2, i, j1 * 512, k, anIntArray137[j1] * i4, k2, ((Animable) (obj13)), l, byte0, anIntArray144[j1] * i4, anIntArray152[j1]);
            return;
        }
        if (j == 6) {
            Object obj8;
            if (class46.anInt781 == -1 && class46.childrenIDs == null) {
                ...
                obj8 = new AnimableObject(i1, 0, 4, l1, (byte) 7, i2, k1, j2, class46.anInt781, true);
            }
            class25.method283(l2, i, j1, k, 0, k2, ((Animable) (obj8)), l, byte0, 0, 256);
            return;
        }
        if (j == 7) {
            Object obj9;
            if (class46.anInt781 == -1 && class46.childrenIDs == null) {
                ...
                obj9 = new AnimableObject(i1, 0, 4, l1, (byte) 7, i2, k1, j2, class46.anInt781, true);
            }
            class25.method283(l2, i, j1, k, 0, k2, ((Animable) (obj9)), l, byte0, 0, 512);
            return;
        }
        if (j == 8) {
            Object obj10;
            if (class46.anInt781 == -1 && class46.childrenIDs == null) {
                ...
                obj10 = new AnimableObject(i1, 0, 4, l1, (byte) 7, i2, k1, j2, class46.anInt781, true);
            }
            class25.method283(l2, i, j1, k, 0, k2, ((Animable) (obj10)), l, byte0, 0, 768);
        }
    }
    ...
    public final void method179(int i, int j, MapRegion aclass11[], int k, int l, int i1, byte abyte0[],
            int j1, int k1, int l1) {
        for (int i2 = 0; i2 < 8; i2++) {
            for (int j2 = 0; j2 < 8; j2++) {
                if (l + i2 > 0 && l + i2 < 103 && l1 + j2 > 0 && l1 + j2 < 103) {
                    aclass11[k1].mapRegionArea[l + i2][l1 + j2] &= 0xfeffffff;
                }
            }
            ...
            for (int i3 = 0; i3 < 64; i3++) {
                for (int j3 = 0; j3 < 64; j3++) {
                    if (l2 == i && i3 >= i1 && i3 < i1 + 8 && j3 >= j1 && j3 < j1 + 8) {
                        method181(l1 + Class4.method156(j3 & 7, j, i3 & 7), 0, class30_sub2_sub2, l + Class4.method155(j, j3 & 7, i3 & 7), k1, j, 942, 0);
                    } else {
    ...
    public final void method180(byte abyte0[], int i, int j, int k, int l, byte byte0, MapRegion aclass11[]) {
        for (int i1 = 0; i1 < 4; i1++) {
            for (int j1 = 0; j1 < 64; j1++) {
                for (int k1 = 0; k1 < 64; k1++) {
                    if (j + j1 > 0 && j + j1 < 103 && i + k1 > 0 && i + k1 < 103) {
                        aclass11[i1].mapRegionArea[j + j1][i + k1] &= 0xfeffffff;
                    }
                }
    ...
    private void method181(int i, int j, Packet class30_sub2_sub2, int k, int l, int i1, int j1,
            int k1) {
        j1 = 36 / j1;
        if (k >= 0 && k < 104 && i >= 0 && i < 104) {
            ...
            do {
                ...
                if (l1 <= 49) {
                    aByteArrayArrayArray130[l][k][i] = class30_sub2_sub2.readSignedByte();
    ...
    public final void method183(MapRegion aclass11[], WorldController class25, int i, int j, int k, boolean flag, int l,
        ...
        label0:
        {
            ...
            do {
                ...
                do {
                    ...
                    int i3 = j2 >> 6 & 0x3f;
                    int j3 = j2 >> 12;
                    int k3 = class30_sub2_sub2.readUnsignedByte();
                    int l3 = k3 >> 2;
                    int i4 = k3 & 3;
                    if (j3 == i && i3 >= i1 && i3 < i1 + 8 && l2 >= k && l2 < k + 8) {
                        ObjectDef class46 = ObjectDef.forID(l1);
                        int j4 = j + Class4.method157(j1, class46.objectHeight, i3 & 7, l2 & 7, class46.objectWidth);
                        int k4 = k1 + Class4.method158(l2 & 7, class46.objectHeight, j1, class46.objectWidth, i3 & 7);
                        if (j4 > 0 && k4 > 0 && j4 < 103 && k4 < 103) {
                            int l4 = j3;
                            if ((aByteArrayArrayArray149[1][j4][k4] & 2) == 2) {
                                l4--;
                            }
                            MapRegion class11 = null;
                            if (l4 >= 0) {
                                class11 = aclass11[l4];
                            }
    ...
    private static int method184(int i, int j, int k, int l) {
        int i1 = 0x10000 - Jagex3DCanvas.anIntArray1471[(k * 1024) / l] >> 1;
    ...
    public static void method188(WorldController class25, int i, int j, int k, int l, MapRegion class11, int ai[][][], int i1, int j1, int k1) {
        int l1 = ai[l][i1][j];
        int i2 = ai[l][i1 + 1][j];
        ...
        if (k == 22) {
            ...
            if (class46.anInt781 == -1 && class46.childrenIDs == null) {
                ...
                obj = new AnimableObject(j1, i, 22, i2, (byte) 7, j2, l1, k2, class46.anInt781, true);
            }
            class25.method280(k1, l2, j, ((Animable) (obj)), byte1, i3, i1);
        ...
        if (k == 10 || k == 11) {
            ...
            if (class46.anInt781 == -1 && class46.childrenIDs == null) {
                ...
                obj1 = new AnimableObject(j1, i, 10, i2, (byte) 7, j2, l1, k2, class46.anInt781, true);
            }
            if (obj1 != null) {
                int j5 = 0;
                if (k == 11) {
                ...
                int i5;
                if (i == 1 || i == 3) {
                    k4 = class46.objectHeight;
                    i5 = class46.objectWidth;
                } else {
                    k4 = class46.objectWidth;
                    i5 = class46.objectHeight;
                }
                class25.method284(i3, l2, i5, ((Animable) (obj1)), k4, k1, j5, (byte) 110, j, i1);
            }
            if (class46.aBoolean767) {
                class11.method212(class46.aBoolean757, class46.objectWidth, class46.objectHeight, i1, j, i);
            }
            return;
        }
        if (k >= 12) {
            ...
            if (class46.anInt781 == -1 && class46.childrenIDs == null) {
                ...
                obj2 = new AnimableObject(j1, i, k, i2, (byte) 7, j2, l1, k2, class46.anInt781, true);
            }
            class25.method284(i3, l2, 1, ((Animable) (obj2)), 1, k1, 0, (byte) 110, j, i1);
            if (class46.aBoolean767) {
                class11.method212(class46.aBoolean757, class46.objectWidth, class46.objectHeight, i1, j, i);
            }
            return;
        ...
        if (k == 0) {
            ...
            if (class46.anInt781 == -1 && class46.childrenIDs == null) {
                ...
                obj3 = new AnimableObject(j1, i, 0, i2, (byte) 7, j2, l1, k2, class46.anInt781, true);
            }
            class25.method282(anIntArray152[i], ((Animable) (obj3)), true, i3, j, byte1, i1, null, l2, 0, k1);
            if (class46.aBoolean767) {
        ...
        if (k == 1) {
            ...
            if (class46.anInt781 == -1 && class46.childrenIDs == null) {
                ...
                obj4 = new AnimableObject(j1, i, 1, i2, (byte) 7, j2, l1, k2, class46.anInt781, true);
            }
            class25.method282(anIntArray140[i], ((Animable) (obj4)), true, i3, j, byte1, i1, null, l2, 0, k1);
            if (class46.aBoolean767) {
                class11.method211(j, i, i1, k, class46.aBoolean757);
            }
            return;
        ...
        if (k == 2) {
            ...
            if (class46.anInt781 == -1 && class46.childrenIDs == null) {
                ...
                obj11 = new AnimableObject(j1, 4 + i, 2, i2, (byte) 7, j2, l1, k2, class46.anInt781, true);
                obj12 = new AnimableObject(j1, j3, 2, i2, (byte) 7, j2, l1, k2, class46.anInt781, true);
            }
            class25.method282(anIntArray152[i], ((Animable) (obj11)), true, i3, j, byte1, i1, ((Animable) (obj12)), l2, anIntArray152[j3], k1);
            if (class46.aBoolean767) {
                class11.method211(j, i, i1, k, class46.aBoolean757);
            }
            return;
        ...
        if (k == 3) {
            ...
            if (class46.anInt781 == -1 && class46.childrenIDs == null) {
                ...
                obj5 = new AnimableObject(j1, i, 3, i2, (byte) 7, j2, l1, k2, class46.anInt781, true);
            }
            class25.method282(anIntArray140[i], ((Animable) (obj5)), true, i3, j, byte1, i1, null, l2, 0, k1);
            if (class46.aBoolean767) {
                class11.method211(j, i, i1, k, class46.aBoolean757);
            }
            return;
        ...
        if (k == 9) {
            ...
            if (class46.anInt781 == -1 && class46.childrenIDs == null) {
                ...
                obj6 = new AnimableObject(j1, i, k, i2, (byte) 7, j2, l1, k2, class46.anInt781, true);
            }
            class25.method284(i3, l2, 1, ((Animable) (obj6)), 1, k1, 0, (byte) 110, j, i1);
            if (class46.aBoolean767) {
                class11.method212(class46.aBoolean757, class46.objectWidth, class46.objectHeight, i1, j, i);
            }
            return;
        ...
        if (k == 4) {
            ...
            if (class46.anInt781 == -1 && class46.childrenIDs == null) {
                ...
                obj7 = new AnimableObject(j1, 0, 4, i2, (byte) 7, j2, l1, k2, class46.anInt781, true);
            }
            class25.method283(i3, j, i * 512, k1, 0, l2, ((Animable) (obj7)), i1, byte1, 0, anIntArray152[i]);
            return;
        }
        if (k == 5) {
            int j4 = 16;
            ...
            if (class46.anInt781 == -1 && class46.childrenIDs == null) {
                ...
                obj13 = new AnimableObject(j1, 0, 4, i2, (byte) 7, j2, l1, k2, class46.anInt781, true);
            }
            class25.method283(i3, j, i * 512, k1, anIntArray137[i] * j4, l2, ((Animable) (obj13)), i1, byte1, anIntArray144[i] * j4, anIntArray152[i]);
            return;
        }
        if (k == 6) {
            Object obj8;
            if (class46.anInt781 == -1 && class46.childrenIDs == null) {
                ...
                obj8 = new AnimableObject(j1, 0, 4, i2, (byte) 7, j2, l1, k2, class46.anInt781, true);
            }
            class25.method283(i3, j, i, k1, 0, l2, ((Animable) (obj8)), i1, byte1, 0, 256);
            return;
        }
        if (k == 7) {
            Object obj9;
            if (class46.anInt781 == -1 && class46.childrenIDs == null) {
                ...
                obj9 = new AnimableObject(j1, 0, 4, i2, (byte) 7, j2, l1, k2, class46.anInt781, true);
            }
            class25.method283(i3, j, i, k1, 0, l2, ((Animable) (obj9)), i1, byte1, 0, 512);
            return;
        }
        if (k == 8) {
            Object obj10;
            if (class46.anInt781 == -1 && class46.childrenIDs == null) {
                ...
                obj10 = new AnimableObject(j1, 0, 4, i2, (byte) 7, j2, l1, k2, class46.anInt781, true);
            }
            class25.method283(i3, j, i, k1, 0, l2, ((Animable) (obj10)), i1, byte1, 0, 768);
        }
    }
    ...
    public static final boolean method189(int i, byte[] is, int i_250_, int i_251_) {
        ...
        boolean bool = true;
        Packet class30_sub2_sub2 = new Packet(is);
        int i_252_ = -1;
        for (;;) {
            ...
            for (;;) {
                if (bool_255_) {
                    ...
                    int i_260_ = class30_sub2_sub2.readUnsignedByte() >> 2;
                    int i_261_ = i_259_ + i;
    ...
    public final void method190(int i, MapRegion aclass11[], int j, int k, WorldController class25, byte abyte0[]) {
        label0:
        {
            if (k < 7 || k > 7) {
                return;
