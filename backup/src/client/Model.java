...
public class Model extends Animable {
    ...
    static {
        modelIntArray1 = Jagex3DCanvas.anIntArray1470;
        modelIntArray2 = Jagex3DCanvas.anIntArray1471;
        modelIntArray3 = Jagex3DCanvas.anIntArray1482;
        modelIntArray4 = Jagex3DCanvas.anIntArray1469;
    }
    ...
    private Model(int i, int j) {
        ...
        Packet class30_sub2_sub2 = new Packet(class21.data);
        class30_sub2_sub2.currentOffset = class21.dirOffset;
        Packet class30_sub2_sub2_1 = new Packet(class21.data);
        class30_sub2_sub2_1.currentOffset = class21.xsOffset;
        Packet class30_sub2_sub2_2 = new Packet(class21.data);
        class30_sub2_sub2_2.currentOffset = class21.ysOffset;
        Packet class30_sub2_sub2_3 = new Packet(class21.data);
        class30_sub2_sub2_3.currentOffset = class21.zsOffset;
        Packet class30_sub2_sub2_4 = new Packet(class21.data);
    ...
    public void method464(int i, Model class30_sub2_sub4_sub6, boolean flag) {
        ...
        anIntArray1638 = class30_sub2_sub4_sub6.anIntArray1638;
        anInt1641 = class30_sub2_sub4_sub6.anInt1641;
        triangleSkin = class30_sub2_sub4_sub6.triangleSkin;
        vertexSkin = class30_sub2_sub4_sub6.vertexSkin;
        facePoint1 = class30_sub2_sub4_sub6.facePoint1;
        facePoint2 = class30_sub2_sub4_sub6.facePoint2;
        facePoint3 = class30_sub2_sub4_sub6.facePoint3;
        anIntArray1634 = class30_sub2_sub4_sub6.anIntArray1634;
    ...
    public void method470(int i, int j) {
        ...
        AnimationHeader class36 = AnimationHeader.method531(i);
        if (class36 == null) {
            return;
        }
    ...
    public void method471(int i, int ai[], int j, int k) {
        ...
        AnimationHeader class36 = AnimationHeader.method531(k);
        if (class36 == null) {
            return;
        }
        AnimationHeader class36_1 = AnimationHeader.method531(j);
        if (i != -20491) {
            return;
        }
        if (class36_1 == null) {
    ...
    public final void method479(int i, int j, int k, int l, int i1, boolean flag) {
        ...
        if (flag) {
            ...
            aClass33Array1660 = new VertexNormal[numVertices];
    ...
    public final void method482(int i, int j, int k, int l, int i1, int j1, int k1) {
        int l1 = Jagex3DCanvas.textureInt1;
        int i2 = Jagex3DCanvas.textureInt2;
    ...
    public final void method443(int i, int j, int k, int l, int i1, int j1, int k1,
        ...
        if (i2 > 0 && aBoolean1684) {
            ...
            int i6 = anInt1685 - Jagex3DCanvas.textureInt1;
            int k6 = anInt1686 - Jagex3DCanvas.textureInt2;
        ...
        int l5 = Jagex3DCanvas.textureInt1;
        int j6 = Jagex3DCanvas.textureInt2;
        int l6 = 0;
        int i7 = 0;
        if (i != 0) {
            l6 = modelIntArray1[i];
    ...
    private final void method484(int i) {
        ...
        int k = facePoint2[i];
        int l = facePoint3[i];
        Jagex3DCanvas.aBoolean1462 = aBooleanArray1663[i];
        if (anIntArray1639 == null) {
            Jagex3DCanvas.anInt1465 = 0;
        } else {
            Jagex3DCanvas.anInt1465 = anIntArray1639[i];
        }
        int i1;
        if (anIntArray1637 == null) {
            i1 = 0;
        ...
        if (i1 == 0) {
            Jagex3DCanvas.method374(anIntArray1666[j], anIntArray1666[k], anIntArray1666[l], anIntArray1665[j], anIntArray1665[k], anIntArray1665[l], anIntArray1634[i], anIntArray1635[i], anIntArray1636[i]);
            return;
        }
        if (i1 == 1) {
            Jagex3DCanvas.method376(anIntArray1666[j], anIntArray1666[k], anIntArray1666[l], anIntArray1665[j], anIntArray1665[k], anIntArray1665[l], modelIntArray3[anIntArray1634[i]]);
            return;
        }
        if (i1 == 2) {
    ...
    private final void method485(int i) {
        int j = Jagex3DCanvas.textureInt1;
        int k = Jagex3DCanvas.textureInt2;
        int l = 0;
        int i1 = facePoint1[i];
        int j1 = facePoint2[i];
        int k1 = facePoint3[i];
        ...
        if ((j3 - j4) * (k7 - j7) - (i7 - j7) * (j5 - j4) > 0) {
            ...
            if (l == 3) {
                ...
                if (l7 == 0) {
                    Jagex3DCanvas.method374(i7, j7, k7, j3, j4, j5, anIntArray1680[0], anIntArray1680[1], anIntArray1680[2]);
                } else if (l7 == 1) {
                    Jagex3DCanvas.method376(i7, j7, k7, j3, j4, j5, modelIntArray3[anIntArray1634[i]]);
                } else if (l7 == 2) {
                    int j8 = anIntArray1637[i] >> 2;
                    int k9 = texTrianglesPoint1[j8];
                    int k10 = texTrianglesPoint2[j8];
                    int k11 = texTrianglesPoint3[j8];
                    Jagex3DCanvas.method378(i7, j7, k7, j3, j4, j5, anIntArray1680[0], anIntArray1680[1], anIntArray1680[2], anIntArray1668[k9], anIntArray1668[k10], anIntArray1668[k11], anIntArray1669[k9], anIntArray1669[k10], anIntArray1669[k11], anIntArray1670[k9], anIntArray1670[k10], anIntArray1670[k11], trianglecolours[i]);
                } else if (l7 == 3) {
                    int k8 = anIntArray1637[i] >> 2;
                    int l9 = texTrianglesPoint1[k8];
                    int l10 = texTrianglesPoint2[k8];
                    int l11 = texTrianglesPoint3[k8];
                    Jagex3DCanvas.method378(i7, j7, k7, j3, j4, j5, anIntArray1634[i], anIntArray1634[i], anIntArray1634[i], anIntArray1668[l9], anIntArray1668[l10], anIntArray1668[l11], anIntArray1669[l9], anIntArray1669[l10], anIntArray1669[l11], anIntArray1670[l9], anIntArray1670[l10], anIntArray1670[l11], trianglecolours[i]);
                }
            }
            if (l == 4) {
                ...
                if (i8 == 0) {
                    Jagex3DCanvas.method374(i7, j7, k7, j3, j4, j5, anIntArray1680[0], anIntArray1680[1], anIntArray1680[2]);
                    Jagex3DCanvas.method374(i7, k7, anIntArray1679[3], j3, j5, anIntArray1678[3], anIntArray1680[0], anIntArray1680[2], anIntArray1680[3]);
                    return;
                }
                if (i8 == 1) {
                    int l8 = modelIntArray3[anIntArray1634[i]];
                    Jagex3DCanvas.method376(i7, j7, k7, j3, j4, j5, l8);
                    Jagex3DCanvas.method376(i7, k7, anIntArray1679[3], j3, j5, anIntArray1678[3], l8);
                    return;
                }
                if (i8 == 2) {
                    ...
                    Jagex3DCanvas.method378(i7, j7, k7, j3, j4, j5, anIntArray1680[0], anIntArray1680[1], anIntArray1680[2], anIntArray1668[i10], anIntArray1668[i11], anIntArray1668[i12], anIntArray1669[i10], anIntArray1669[i11], anIntArray1669[i12], anIntArray1670[i10], anIntArray1670[i11], anIntArray1670[i12], trianglecolours[i]);
                    Jagex3DCanvas.method378(i7, k7, anIntArray1679[3], j3, j5, anIntArray1678[3], anIntArray1680[0], anIntArray1680[2], anIntArray1680[3], anIntArray1668[i10], anIntArray1668[i11], anIntArray1668[i12], anIntArray1669[i10], anIntArray1669[i11], anIntArray1669[i12], anIntArray1670[i10], anIntArray1670[i11], anIntArray1670[i12], trianglecolours[i]);
                    return;
                }
                if (i8 == 3) {
                    ...
                    Jagex3DCanvas.method378(i7, j7, k7, j3, j4, j5, anIntArray1634[i], anIntArray1634[i], anIntArray1634[i], anIntArray1668[j10], anIntArray1668[j11], anIntArray1668[j12], anIntArray1669[j10], anIntArray1669[j11], anIntArray1669[j12], anIntArray1670[j10], anIntArray1670[j11], anIntArray1670[j12], trianglecolours[i]);
                    Jagex3DCanvas.method378(i7, k7, anIntArray1679[3], j3, j5, anIntArray1678[3], anIntArray1634[i], anIntArray1634[i], anIntArray1634[i], anIntArray1668[j10], anIntArray1668[j11], anIntArray1668[j12], anIntArray1669[j10], anIntArray1669[j11], anIntArray1669[j12], anIntArray1670[j10], anIntArray1670[j11], anIntArray1670[j12], trianglecolours[i]);
                }
            }
        }
    }
