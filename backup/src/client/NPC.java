...
final class NPC extends Entity {
    ...
    private Model method450() {
        if (super.anim >= 0 && super.anInt1529 == 0) {
            int k = Animation.anims[super.anim].animationFrames[super.anInt1527];
            int i1 = -1;
        ...
        if (super.anInt1517 >= 0) {
            l = Animation.anims[super.anInt1517].animationFrames[super.anInt1518];
        }
    ...
    public final Model getRotatedModel() {
        ...
        if (super.anInt1520 != -1 && super.anInt1521 != -1) {
            ...
            if (class30_sub2_sub4_sub6_1 != null) {
                int j = class23.aClass20_407.animationFrames[super.anInt1521];
                Model class30_sub2_sub4_sub6_2 = new Model(9, true, AnimationHeader.method532(j), false, class30_sub2_sub4_sub6_1);
                ...
                if (class23.anInt410 != 128 || class23.anInt411 != 128) {
                    class30_sub2_sub4_sub6_2.scaleT(class23.anInt410, class23.anInt410, class23.anInt411);
                }
