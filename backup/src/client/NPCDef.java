...
final class NPCDef {
    ...
    public static final NPCDef forID(int i) {
        ...
        NPCDef class5 = cache[anInt56] = new NPCDef();
    ...
    public final Model getEntityModel() {
        if (childrenIDs != null) {
            NPCDef class5 = method161(anInt64);
            if (class5 == null) {
                return null;
            } else {
                return class5.getEntityModel();
            }
        }
        ...
        for (int j = 0; j < anIntArray73.length; j++) {
            aclass30_sub2_sub4_sub6[j] = Model.getModel(anIntArray73[j]);
        }
    ...
    public final NPCDef method161(int i) {
        int j = -1;
        if (i != 1834) {
    ...
    public static void unpackConfig(JagexArchive streamLoader) {
        stream = new Packet(streamLoader.getDataForName("npc.dat"));
        Packet class30_sub2_sub2 = new Packet(streamLoader.getDataForName("npc.idx"));
    ...
    public final Model method164(int i, int j, int k, int ai[]) {
        ...
        Model class30_sub2_sub4_sub6 = (Model) MemCache.insertFromCache(type);
        if (i != 0) {
            for (int l = 1; l > 0; l++);
        }
        if (class30_sub2_sub4_sub6 == null) {
            ...
            for (int j1 = 0; j1 < modelArray.length; j1++) {
                aclass30_sub2_sub4_sub6[j1] = Model.getModel(modelArray[j1]);
            }
            if (aclass30_sub2_sub4_sub6.length == 1) {
                class30_sub2_sub4_sub6 = aclass30_sub2_sub4_sub6[0];
            } else {
            ...
            MemCache.removeFromCache(class30_sub2_sub4_sub6, type);
        }
        Model class30_sub2_sub4_sub6_1 = Model.aModel_1621;
        class30_sub2_sub4_sub6_1.method464(7, class30_sub2_sub4_sub6, AnimationHeader.method532(k) & AnimationHeader.method532(j));
        if (k != -1 && j != -1) {
        ...
        if (anInt91 != 128 || anInt86 != 128) {
            class30_sub2_sub4_sub6_1.scaleT(anInt91, anInt91,  anInt86);
        }
        class30_sub2_sub4_sub6_1.calculateDiagonals(false);
    ...
    private void readValues(Packet stream) {
        do {
            ...
            if (i == 1) {
                ...
                turn90CCAnimIndex = stream.readUnsignedWord();
            } else if (i >= 30 && i < 40) {
                if (actions == null) {
