...
// END OF OBJECTS //
    ...
    public static void unpackConfig(JagexArchive class44) {
        stream = new Packet(class44.getDataForName("loc.dat"));
        Packet class30_sub2_sub2 = new Packet(class44.getDataForName("loc.idx"));
    ...
    private final Model method581(int i, int j, int k, int l) {
        ...
        if (anIntArray776 == null) {
            ...
            for (int i2 = 0; i2 < k1; i2++) {
                ...
                if (class30_sub2_sub4_sub6 == null) {
                    ...
                    mruNodes1.removeFromCache(class30_sub2_sub4_sub6, l2);
                }
                if (k1 > 1) {
            ...
            if (class30_sub2_sub4_sub6 == null) {
                ...
                mruNodes1.removeFromCache(class30_sub2_sub4_sub6, j2);
            }
        }
        boolean flag;
        ...
        Model class30_sub2_sub4_sub6_3 = new Model(9, modifiedModelColors == null, AnimationHeader.method532(k), l == 0 && k == -1 && !flag && !flag2, class30_sub2_sub4_sub6);
        if (k != -1) {
        ...
        mruNodes2.removeFromCache(class30_sub2_sub4_sub6_3, l1);
        if (i != 0) {
            anInt743 = 422;
        }
    ...
    private final void readValues(Packet stream) {
        int i = -1;
        label0:
        do {
            int j;
