...
public class OnDemandFetcher extends OnDemandFetcherParent implements Runnable {
    ...
    private Container aClass19_1344;
    ...
    private Container aClass19_1358;
    ...
    private Container aClass19_1368;
    private OnDemandData current;
    private Container aClass19_1370;
    ...
    public OnDemandFetcher() {
        ...
        aClass19_1344 = new Container();
        anInt1352 = 13603;
        running = true;
        aBoolean1355 = false;
        waiting = false;
        aClass19_1358 = new Container();
        gzipInputBuffer = new byte[65000];
        nodeSubList = new NodeSubList();
        versions = new int[4][];
        crcs = new int[4][];
        aClass19_1368 = new Container();
        aClass19_1370 = new Container();
    }
    ...
    public final void start(JagexArchive class44, client client) {
        ...
        for (int k = 0; k < 4; k++) {
            ...
            Packet class30_sub2_sub2_1 = new Packet(abyte1);
            crcs[k] = new int[i1];
