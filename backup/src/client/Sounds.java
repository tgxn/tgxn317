...
public class Sounds {
    ...
    private static Packet aClass30_Sub2_Sub2_328;
    ...
    public static void unpack(int i, Packet class30_sub2_sub2) {
        aByteArray327 = new byte[0x6baa8];
        aClass30_Sub2_Sub2_328 = new Packet(aByteArray327);
        if (i != 0) {
    ...
    private void method242(Packet class30_sub2_sub2) {
        for (int i = 0; i < 10; i++) {
    ...
    private Packet method244(int i, int j) {
        int k = method245(i);
