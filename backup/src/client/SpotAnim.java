...
public class SpotAnim {
    ...
    public static void unpackConfig(JagexArchive class44) {
        Packet class30_sub2_sub2 = new Packet(class44.getDataForName("spotanim.dat"));
    ...
    public Model getModel() {
        ...
        class30_sub2_sub4_sub6 = Model.getModel(anInt405);
        if (class30_sub2_sub4_sub6 == null) {
            return null;
        }
        for (int i = 0; i < 6; i++) {
        ...
        aMRUNodes_415.removeFromCache(class30_sub2_sub4_sub6, anInt404);
        return class30_sub2_sub4_sub6;
    }
}
