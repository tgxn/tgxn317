...
public final class Sprite extends DrawingArea {
    ...
    public Sprite(JagexArchive class44, String s, int i) {
        Packet class30_sub2_sub2 = new Packet(class44.getDataForName((new StringBuilder()).append(s).append(".dat").toString()));
        Packet class30_sub2_sub2_1 = new Packet(class44.getDataForName("index.dat"));
