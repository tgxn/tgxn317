...
public class client extends RSApplet {
    ...
    private Packet aClass30_Sub2_Sub2_847;
    ...
    private Packet aClass30_Sub2_Sub2Array895[];
    ...
    private Container aClass19_1013;
    ...
    private Container aClass19_1056;
    ...
    private RSImageProducer bottomChatArea;
    private RSImageProducer bottomTabArea;
    private RSImageProducer topTabArea;
    ...
    private RSImageProducer inventoryArea;
    ...
    private Container aClass19_1179;
    ...
    static {
       ...
       public client() {
        ...
        groundArray = new Container[4][104][104];
        aBoolean830 = true;
        aBoolean831 = false;
        aClass30_Sub2_Sub2_834 = new Packet(new byte[5000]);
        npcArray = new NPC[16384];
        npcIndices = new int[16384];
        anInt838 = 9;
        anIntArray840 = new int[1000];
        aClass30_Sub2_Sub2_847 = Packet.create(1, 9);
        aBoolean848 = true;
        openInterfaceID = -1;
        ...
        aClass30_Sub2_Sub2Array895 = new Packet[maxPlayers];
        anInt897 = 1;
        ...
        aClass19_1179 = new Container();
        anInt1184 = 128;
        invOverlayInterfaceID = -1;
        stream = Packet.create(1, 9);
        aByte1194 = 5;
    ...
    public void processExtraMenus() { //Extra Right-Clisck Menus
        ...
        //Logout Button
        if (super.mouseX >= 765 - 20 && super.mouseX <= 765 - 1 && super.mouseY >= 1 && super.mouseY < 23) {
        ...
        //Help Button
        if (super.mouseX >= 765 - 42 && super.mouseX <= 765 - 22 && super.mouseY >= 1 && super.mouseY < 23) {
        ...
        //QC Button
        if (super.mouseX >= qcFromLeft && super.mouseX <= qcFromLeft + 14 && super.mouseY >= qcFromTop && super.mouseY <= qcFromTop + 14) {
        ...
        //Compass Button
        if (super.mouseX >= 522 && super.mouseX <= 558 && super.mouseY >= 5 && super.mouseY < 42) {
        ...
        //Zoom + Button
        if (super.mouseX >= 529 && super.mouseX <= 542 && super.mouseY >= 60 && super.mouseY <= 73) {
        ...
        //Zoom - Button
        if (super.mouseX >= 527 && super.mouseX <= 540 && super.mouseY >= 76 && super.mouseY <= 89) {
        ...
        //Top Tabs
        if (super.mouseX >= 524 && super.mouseX <= 561 && super.mouseY >= 168 && super.mouseY < 204 && tabInterfaceIDs[0] != -1) {
            menuActionName[1] = "Combat Styles";
            menuActionID[1] = 1001;
            menuActionRow++;
        } else if (super.mouseX >= 562 && super.mouseX <= 594 && super.mouseY >= 168 && super.mouseY < 204 && tabInterfaceIDs[1] != -1) {
            menuActionName[1] = "Stats";
            menuActionID[1] = 1002;
            menuActionRow++;
        } else if (super.mouseX >= 595 && super.mouseX <= 627 && super.mouseY >= 168 && super.mouseY < 204 && tabInterfaceIDs[2] != -1) {
            //menuActionName[1] = "Quest List";
            menuActionName[1] = "News";
            menuActionID[1] = 1003;
            menuActionRow++;
        } else if (super.mouseX >= 628 && super.mouseX <= 660 && super.mouseY >= 168 && super.mouseY < 204 && tabInterfaceIDs[3] != -1) {
            menuActionName[1] = "Inventory";
            menuActionID[1] = 1004;
            menuActionRow++;
        } else if (super.mouseX >= 661 && super.mouseX <= 693 && super.mouseY >= 168 && super.mouseY < 204 && tabInterfaceIDs[4] != -1) {
            menuActionName[1] = "Worn Equipment";
            menuActionID[1] = 1005;
            menuActionRow++;
        } else if (super.mouseX >= 694 && super.mouseX <= 726 && super.mouseY >= 168 && super.mouseY < 204 && tabInterfaceIDs[5] != -1) {
            menuActionName[1] = "Prayer List";
            menuActionID[1] = 1006;
            menuActionRow++;
        } else if (super.mouseX >= 727 && super.mouseX <= 763 && super.mouseY >= 168 && super.mouseY < 205 && tabInterfaceIDs[6] != -1) {
        ...
        //Bottom tabs
        if (super.mouseX >= 524 && super.mouseX <= 561 && super.mouseY >= 467 && super.mouseY < 503 && tabInterfaceIDs[8] != -1) {
            menuActionName[1] = "Notes";
            menuActionID[1] = 1008;
            menuActionRow++;
        } else if (super.mouseX >= 562 && super.mouseX <= 594 && super.mouseY >= 467 && super.mouseY < 503 && tabInterfaceIDs[8] != -1) {
            menuActionName[1] = "Friend List";
            menuActionID[1] = 1009;
            menuActionRow++;
        } else if (super.mouseX >= 595 && super.mouseX <= 627 && super.mouseY >= 467 && super.mouseY < 503 && tabInterfaceIDs[9] != -1) {
            menuActionName[1] = "Ignore List";
            menuActionID[1] = 1010;
            menuActionRow++;
        } else if (super.mouseX >= 628 && super.mouseX <= 660 && super.mouseY >= 467 && super.mouseY < 503 && tabInterfaceIDs[10] != -1) {
            menuActionName[1] = "Clan Chat";
            menuActionID[1] = 1011;
            menuActionRow++;
        } else if (super.mouseX >= 661 && super.mouseX <= 693 && super.mouseY >= 467 && super.mouseY < 503 && tabInterfaceIDs[11] != -1) {
            menuActionName[1] = "Options";
            menuActionID[1] = 1012;
            menuActionRow++;
        } else if (super.mouseX >= 694 && super.mouseX <= 726 && super.mouseY >= 467 && super.mouseY < 503 && tabInterfaceIDs[12] != -1) {
            menuActionName[1] = "Emotes";
            menuActionID[1] = 1013;
            menuActionRow++;
        } else if (super.mouseX >= 727 && super.mouseX <= 763 && super.mouseY >= 467 && super.mouseY < 503 && tabInterfaceIDs[13] != -1) {
        ...
        //Chat Options
        if (super.mouseX >= 3 && super.mouseX <= 59 && super.mouseY >= 481 && super.mouseY <= 503) {
            menuActionName[1] = "View All";
            menuActionID[1] = 1450;
            menuActionRow++;
        }
        if (super.mouseX >= 61 && super.mouseX <= 116 && super.mouseY >= 481 && super.mouseY <= 503) {
        ...
        if (super.mouseX >= 118 && super.mouseX <= 173 && super.mouseY >= 481 && super.mouseY <= 503) {
        ...
        if (super.mouseX >= 175 && super.mouseX <= 230 && super.mouseY >= 481 && super.mouseY <= 503) {
        ...
        if (super.mouseX >= 232 && super.mouseX <= 287 && super.mouseY >= 481 && super.mouseY <= 503) {
        ...
        if (super.mouseX >= 289 && super.mouseX <= 344 && super.mouseY >= 481 && super.mouseY <= 503) {
        ...
        //Options Button
        if (super.mouseX >= 346 && super.mouseX <= 401 && super.mouseY >= 481 && super.mouseY <= 503) {
        ...
        //Report Abuse Button
        if (super.mouseX >= 403 && super.mouseX <= 513 && super.mouseY >= 481 && super.mouseY <= 503) {
    ...
    public final void drawChatArea() {
        ...
        Jagex3DCanvas.anIntArray1472 = anIntArray1180;
        ...
        if (messagePromptRaised) {
            ...
            DrawingArea.createDrawingArea(0, 0, 486, 113);
        ...
        Jagex3DCanvas.anIntArray1472 = anIntArray1182;
    }
    ...
    public final void method25(int i, int j) {
        Container class19 = groundArray[plane][i][j];
        if (class19 == null) {
    ...
    public final void method33(int i) {
        ...
        if (j == 1) {
            if (k == 1) {
                Jagex3DCanvas.method372(0.90000000000000002D);
            }
            if (k == 2) {
                Jagex3DCanvas.method372(0.80000000000000004D);
            }
            if (k == 3) {
                Jagex3DCanvas.method372(0.69999999999999996D);
            }
            if (k == 4) {
                Jagex3DCanvas.method372(0.59999999999999998D);
            }
            ItemDef.mruNodes1.unlinkAll();
    ...
    public final void method34(int i) { //updateEntities
        ...
        for (int j = -1; j < anInt891 + npcCount; j++) {
            ...
            if (((Entity) (obj)).aString1506 != null && (j >= anInt891 || publicChatMode == 0 || publicChatMode == 3 || publicChatMode == 1 && isCurrentPlayerName(Player.name))) {
                method127(true, ((Entity) (obj)), ((Entity) (obj)).height);
                if (spriteDrawX > -1 && anInt974 < anInt975) {
                    anIntArray979[anInt974] = boldFont.getTextWidth(((Entity) (obj)).aString1506) / 2;
        ...
        for (int k = 0; k < anInt974; k++) {
            ...
            if (anInt1249 == 0) {
                ...
                if (anIntArray981[k] == 4) {
                    ...
                    DrawingArea.createDrawingArea(spriteDrawX - 50, 0, spriteDrawX + 50, 334);
                ...
                if (anIntArray981[k] == 5) {
                    ...
                    DrawingArea.createDrawingArea(0, spriteDrawY - boldFont.basicCharSetHeight - 1, 512, spriteDrawY + 5);
    ...
    public final void drawTabArea() { //drawTabArea
        ...
        Jagex3DCanvas.anIntArray1472 = anIntArray1181;
    ...
    public final void method37(int i, int j) {
        ...
        if (!lowMem) {
            if (Jagex3DCanvas.anIntArray1480[17] >= j) {
                Background class30_sub2_sub1_sub2 = Jagex3DCanvas.aClass30_Sub2_Sub1_Sub2Array1474[17];
                ...
                Jagex3DCanvas.method370(17, -477);
                anInt854++;
                if (anInt854 > 1235) {
                    anInt854 = 0;
            ...
            if (Jagex3DCanvas.anIntArray1480[24] >= j) {
                Background class30_sub2_sub1_sub2_1 = Jagex3DCanvas.aClass30_Sub2_Sub1_Sub2Array1474[24];
                ...
                Jagex3DCanvas.method370(24, -477);
            }
            if (Jagex3DCanvas.anIntArray1480[40] >= j) {
                Background class30_sub2_sub1_sub2_1 = Jagex3DCanvas.aClass30_Sub2_Sub1_Sub2Array1474[40];
                int l = class30_sub2_sub1_sub2_1.myWidth * class30_sub2_sub1_sub2_1.myHeight - 1;
                ...
                class30_sub2_sub1_sub2_1.pixelInfo = abyte4;
                aByteArray912 = abyte1;
                Jagex3DCanvas.method370(40, -477);
            }
            if (Jagex3DCanvas.anIntArray1480[34] >= j) {
                Background class30_sub2_sub1_sub2_2 = Jagex3DCanvas.aClass30_Sub2_Sub1_Sub2Array1474[34];
                ...
                Jagex3DCanvas.method370(34, -477);
            }
        }
    }
    ...
    public final void drawMenu() {
        ...
        int savemouseX = super.mouseX;
        int savemouseY = super.mouseY;
    ...
    private void method46(int i, Packet class30_sub2_sub2) {
        while (class30_sub2_sub2.bitPosition + 21 < i * 8) {
            ...
            class30_sub2_sub4_sub1_sub1.anInt1556 = class30_sub2_sub4_sub1_sub1.desc.turn90CCAnimIndex;
            class30_sub2_sub4_sub1_sub1.anInt1557 = class30_sub2_sub4_sub1_sub1.desc.turn90CCWAnimIndex;
            class30_sub2_sub4_sub1_sub1.anInt1511 = class30_sub2_sub4_sub1_sub1.desc.idleAnimation;
            class30_sub2_sub4_sub1_sub1.setPos(((Entity) (myPlayer)).smallX[0] + i1, ((Entity) (myPlayer)).smallY[0] + l, j1 == 1);
        }
    ...
    public final void method47(boolean flag) {
        if (((Entity) (myPlayer)).x >> 7 == destX && ((Entity) (myPlayer)).y >> 7 == destY) {
            destX = 0;
        }
        int j = anInt891;
        if (flag) {
        ...
        for (int l = 0; l < j; l++) {
            ...
            if (class30_sub2_sub4_sub1_sub2.aModel_1714 != null && loopCycle >= class30_sub2_sub4_sub1_sub2.anInt1707 && loopCycle < class30_sub2_sub4_sub1_sub2.anInt1708) {
                ...
                worldController.method286(60, plane, ((Entity) (class30_sub2_sub4_sub1_sub2)).y, class30_sub2_sub4_sub1_sub2, ((Entity) (class30_sub2_sub4_sub1_sub2)).anInt1552, class30_sub2_sub4_sub1_sub2.anInt1722, ((Entity) (class30_sub2_sub4_sub1_sub2)).x, class30_sub2_sub4_sub1_sub2.anInt1709, class30_sub2_sub4_sub1_sub2.anInt1719, class30_sub2_sub4_sub1_sub2.anInt1721, i1, class30_sub2_sub4_sub1_sub2.anInt1720);
                continue;
            }
            ...
            class30_sub2_sub4_sub1_sub2.anInt1709 = method42(plane, ((Entity) (class30_sub2_sub4_sub1_sub2)).y, true, ((Entity) (class30_sub2_sub4_sub1_sub2)).x);
            worldController.addEntityToTile(plane, ((Entity) (class30_sub2_sub4_sub1_sub2)).anInt1552, class30_sub2_sub4_sub1_sub2.anInt1709, i1, ((Entity) (class30_sub2_sub4_sub1_sub2)).y, 60, ((Entity) (class30_sub2_sub4_sub1_sub2)).x, class30_sub2_sub4_sub1_sub2, ((Entity) (class30_sub2_sub4_sub1_sub2)).aBoolean1541);
        }
    ...
    private void method49(int i, byte byte0, Packet class30_sub2_sub2) {
        if (byte0 == 2) {
            byte0 = 0;
        } else {
            return;
    ...
    public final void loadingStages() {
        ...
        if (loadingStage == 1) {
            ...
            if (j != 0 && System.currentTimeMillis() - aLong824 > 0x57e40L) {
                signlink.reportError(myUsername + " glcfb " + aLong1215 + "," + j + "," + lowMem + "," + decompressors[0] + "," + aClass42_Sub1_1068.getNodeCount() + "," + plane + "," + anInt1069 + "," + anInt1070);
                aLong824 = System.currentTimeMillis();
            }
        }
        ...
        do {
            ...
            do {
                ...
                if (class30_sub2_sub3.dataType == 1 && class30_sub2_sub3.buffer != null) {
                    AnimationHeader.method529(class30_sub2_sub3.buffer);
                }
            ...
            Map.method173((byte) -107, new Packet(class30_sub2_sub3.buffer), aClass42_Sub1_1068);
        } while (true);
    }
    ...
    public final void mainGameProcessor() {
        ...
        synchronized (mouseDetection.object) {
            if (flagged) {
                if (super.clickMode3 != 0 || mouseDetection.anInt810 >= 40) {
        ...
        if (WorldController.anInt470 != -1) {
            ...
            boolean flag = method85(0, 0, 0, 0, ((Entity) (myPlayer)).smallY[0], 0, 0, k1, ((Entity) (myPlayer)).smallX[0], true, k);
    ...
    public final void resetImageProducers() {
        ...
        loginArea = new RSImageProducer(765, 503, getGameComponent());
...
//                }
    ...
    public final boolean method66(int i, int j, int k, int l) {
        ...
        if (k1 == 10 || k1 == 11 || k1 == 22) {
            ...
            method85(2, 0, j2, 0, ((Entity) (myPlayer)).smallY[0], i2, k2, j, ((Entity) (myPlayer)).smallX[0], false, k);
        } else {
            method85(2, l1, 0, k1 + 1, ((Entity) (myPlayer)).smallY[0], 0, 0, j, ((Entity) (myPlayer)).smallX[0], false, k);
        }
        anInt914 = super.saveClickX;
        anInt915 = super.saveClickY;
        crossType = 2;
    ...
    private JagexArchive streamLoaderForName(int i, String s, String s1, int j, byte byte0, int k) {
        ...
        do {
            ...
            try {
                ...
                Packet class30_sub2_sub2 = new Packet(abyte1);
    ...
    public final void doAction(int i) { //doAction
        ...
        if (l == 20) {
            ...
            if (class30_sub2_sub4_sub1_sub1_1 != null) {
                method85(2, 0, 1, 0, ((Entity) (myPlayer)).smallY[0], 1, 0, ((Entity) (class30_sub2_sub4_sub1_sub1_1)).smallY[0], ((Entity) (myPlayer)).smallX[0], false, ((Entity) (class30_sub2_sub4_sub1_sub1_1)).smallX[0]);
                anInt914 = super.saveClickX;
                anInt915 = super.saveClickY;
                crossType = 2;
                crossIndex = 0;
        ...
        if (l == 27) {
            ...
            if (class30_sub2_sub4_sub1_sub2_2 != null) {
                method85(2, 0, 1, 0, ((Entity) (myPlayer)).smallY[0], 1, 0, ((Entity) (class30_sub2_sub4_sub1_sub2_2)).smallY[0], ((Entity) (myPlayer)).smallX[0], false, ((Entity) (class30_sub2_sub4_sub1_sub2_2)).smallX[0]);
                anInt914 = super.saveClickX;
                anInt915 = super.saveClickY;
                crossType = 2;
                crossIndex = 0;
        ...
        if (l == 582) {
            ...
            if (class30_sub2_sub4_sub1_sub1 != null) {
                method85(2, 0, 1, 0, ((Entity) (myPlayer)).smallY[0], 1, 0, ((Entity) (class30_sub2_sub4_sub1_sub1)).smallY[0], ((Entity) (myPlayer)).smallX[0], false, ((Entity) (class30_sub2_sub4_sub1_sub1)).smallX[0]);
                anInt914 = super.saveClickX;
                anInt915 = super.saveClickY;
                crossType = 2;
                crossIndex = 0;
        ...
        if (l == 234) {
            boolean flag1 = method85(2, 0, 0, 0, ((Entity) (myPlayer)).smallY[0], 0, 0, k, ((Entity) (myPlayer)).smallX[0], false, j);
            if (!flag1) {
                flag1 = method85(2, 0, 1, 0, ((Entity) (myPlayer)).smallY[0], 1, 0, k, ((Entity) (myPlayer)).smallX[0], false, j);
            }
            anInt914 = super.saveClickX;
            anInt915 = super.saveClickY;
            crossType = 2;
        ...
        if (l == 511) {
            boolean flag2 = method85(2, 0, 0, 0, ((Entity) (myPlayer)).smallY[0], 0, 0, k, ((Entity) (myPlayer)).smallX[0], false, j);
            if (!flag2) {
                flag2 = method85(2, 0, 1, 0, ((Entity) (myPlayer)).smallY[0], 1, 0, k, ((Entity) (myPlayer)).smallX[0], false, j);
            }
            anInt914 = super.saveClickX;
            anInt915 = super.saveClickY;
            crossType = 2;
        ...
        if (l == 561) {
            ...
            if (class30_sub2_sub4_sub1_sub2 != null) {
                method85(2, 0, 1, 0, ((Entity) (myPlayer)).smallY[0], 1, 0, ((Entity) (class30_sub2_sub4_sub1_sub2)).smallY[0], ((Entity) (myPlayer)).smallX[0], false, ((Entity) (class30_sub2_sub4_sub1_sub2)).smallX[0]);
                anInt914 = super.saveClickX;
                anInt915 = super.saveClickY;
                crossType = 2;
                crossIndex = 0;
        ...
        if (l == 779) {
            ...
            if (class30_sub2_sub4_sub1_sub2_1 != null) {
                method85(2, 0, 1, 0, ((Entity) (myPlayer)).smallY[0], 1, 0, ((Entity) (class30_sub2_sub4_sub1_sub2_1)).smallY[0], ((Entity) (myPlayer)).smallX[0], false, ((Entity) (class30_sub2_sub4_sub1_sub2_1)).smallX[0]);
                anInt914 = super.saveClickX;
                anInt915 = super.saveClickY;
                crossType = 2;
                crossIndex = 0;
        ...
        if (l == 484 || l == 6) {
            ...
            if (l1 != -1) {
                ...
                for (int j3 = 0; j3 < anInt891; j3++) {
                    ...
                    method85(2, 0, 1, 0, ((Entity) (myPlayer)).smallY[0], 1, 0, ((Entity) (class30_sub2_sub4_sub1_sub2_7)).smallY[0], ((Entity) (myPlayer)).smallX[0], false, ((Entity) (class30_sub2_sub4_sub1_sub2_7)).smallX[0]);
                    if (l == 484) {
        ...
        if (l == 213) {
            boolean flag3 = method85(2, 0, 0, 0, ((Entity) (myPlayer)).smallY[0], 0, 0, k, ((Entity) (myPlayer)).smallX[0], false, j);
            if (!flag3) {
                flag3 = method85(2, 0, 1, 0, ((Entity) (myPlayer)).smallY[0], 1, 0, k, ((Entity) (myPlayer)).smallX[0], false, j);
            }
            anInt914 = super.saveClickX;
            anInt915 = super.saveClickY;
            crossType = 2;
        ...
        if (l == 652) {
            boolean flag4 = method85(2, 0, 0, 0, ((Entity) (myPlayer)).smallY[0], 0, 0, k, ((Entity) (myPlayer)).smallX[0], false, j);
            if (!flag4) {
                flag4 = method85(2, 0, 1, 0, ((Entity) (myPlayer)).smallY[0], 1, 0, k, ((Entity) (myPlayer)).smallX[0], false, j);
            }
            anInt914 = super.saveClickX;
            anInt915 = super.saveClickY;
            crossType = 2;
        ...
        if (l == 94) {
            boolean flag5 = method85(2, 0, 0, 0, ((Entity) (myPlayer)).smallY[0], 0, 0, k, ((Entity) (myPlayer)).smallX[0], false, j);
            if (!flag5) {
                flag5 = method85(2, 0, 1, 0, ((Entity) (myPlayer)).smallY[0], 1, 0, k, ((Entity) (myPlayer)).smallX[0], false, j);
            }
            anInt914 = super.saveClickX;
            anInt915 = super.saveClickY;
            crossType = 2;
        ...
        if (l == 225) {
            ...
            if (class30_sub2_sub4_sub1_sub1_2 != null) {
                method85(2, 0, 1, 0, ((Entity) (myPlayer)).smallY[0], 1, 0, ((Entity) (class30_sub2_sub4_sub1_sub1_2)).smallY[0], ((Entity) (myPlayer)).smallX[0], false, ((Entity) (class30_sub2_sub4_sub1_sub1_2)).smallX[0]);
                anInt914 = super.saveClickX;
                anInt915 = super.saveClickY;
                crossType = 2;
                crossIndex = 0;
        ...
        if (l == 965) {
            ...
            if (class30_sub2_sub4_sub1_sub1_3 != null) {
                method85(2, 0, 1, 0, ((Entity) (myPlayer)).smallY[0], 1, 0, ((Entity) (class30_sub2_sub4_sub1_sub1_3)).smallY[0], ((Entity) (myPlayer)).smallX[0], false, ((Entity) (class30_sub2_sub4_sub1_sub1_3)).smallX[0]);
                anInt914 = super.saveClickX;
                anInt915 = super.saveClickY;
                crossType = 2;
                crossIndex = 0;
        ...
        if (l == 413) {
            ...
            if (class30_sub2_sub4_sub1_sub1_4 != null) {
                method85(2, 0, 1, 0, ((Entity) (myPlayer)).smallY[0], 1, 0, ((Entity) (class30_sub2_sub4_sub1_sub1_4)).smallY[0], ((Entity) (myPlayer)).smallX[0], false, ((Entity) (class30_sub2_sub4_sub1_sub1_4)).smallX[0]);
                anInt914 = super.saveClickX;
                anInt915 = super.saveClickY;
                crossType = 2;
                crossIndex = 0;
        ...
        if (l == 412) {
            ...
            if (class30_sub2_sub4_sub1_sub1_6 != null) {
                method85(2, 0, 1, 0, ((Entity) (myPlayer)).smallY[0], 1, 0, ((Entity) (class30_sub2_sub4_sub1_sub1_6)).smallY[0], ((Entity) (myPlayer)).smallX[0], false, ((Entity) (class30_sub2_sub4_sub1_sub1_6)).smallX[0]);
                anInt914 = super.saveClickX;
                anInt915 = super.saveClickY;
                crossType = 2;
                crossIndex = 0;
        ...
        if (l == 365) {
            ...
            if (class30_sub2_sub4_sub1_sub2_3 != null) {
                method85(2, 0, 1, 0, ((Entity) (myPlayer)).smallY[0], 1, 0, ((Entity) (class30_sub2_sub4_sub1_sub2_3)).smallY[0], ((Entity) (myPlayer)).smallX[0], false, ((Entity) (class30_sub2_sub4_sub1_sub2_3)).smallX[0]);
                anInt914 = super.saveClickX;
                anInt915 = super.saveClickY;
                crossType = 2;
                crossIndex = 0;
        ...
        if (l == 729) {
            ...
            if (class30_sub2_sub4_sub1_sub2_4 != null) {
                method85(2, 0, 1, 0, ((Entity) (myPlayer)).smallY[0], 1, 0, ((Entity) (class30_sub2_sub4_sub1_sub2_4)).smallY[0], ((Entity) (myPlayer)).smallX[0], false, ((Entity) (class30_sub2_sub4_sub1_sub2_4)).smallX[0]);
                anInt914 = super.saveClickX;
                anInt915 = super.saveClickY;
                crossType = 2;
                crossIndex = 0;
        ...
        if (l == 577) {
            ...
            if (class30_sub2_sub4_sub1_sub2_5 != null) {
                method85(2, 0, 1, 0, ((Entity) (myPlayer)).smallY[0], 1, 0, ((Entity) (class30_sub2_sub4_sub1_sub2_5)).smallY[0], ((Entity) (myPlayer)).smallX[0], false, ((Entity) (class30_sub2_sub4_sub1_sub2_5)).smallX[0]);
                anInt914 = super.saveClickX;
                anInt915 = super.saveClickY;
                crossType = 2;
                crossIndex = 0;
        ...
        if (l == 567) {
            boolean flag6 = method85(2, 0, 0, 0, ((Entity) (myPlayer)).smallY[0], 0, 0, k, ((Entity) (myPlayer)).smallX[0], false, j);
            if (!flag6) {
                flag6 = method85(2, 0, 1, 0, ((Entity) (myPlayer)).smallY[0], 1, 0, k, ((Entity) (myPlayer)).smallX[0], false, j);
            }
            anInt914 = super.saveClickX;
            anInt915 = super.saveClickY;
            crossType = 2;
        ...
        if (l == 491) {
            ...
            if (class30_sub2_sub4_sub1_sub2_6 != null) {
                method85(2, 0, 1, 0, ((Entity) (myPlayer)).smallY[0], 1, 0, ((Entity) (class30_sub2_sub4_sub1_sub2_6)).smallY[0], ((Entity) (myPlayer)).smallX[0], false, ((Entity) (class30_sub2_sub4_sub1_sub2_6)).smallX[0]);
                anInt914 = super.saveClickX;
                anInt915 = super.saveClickY;
                crossType = 2;
                crossIndex = 0;
        ...
        if (l == 478) {
            ...
            if (class30_sub2_sub4_sub1_sub1_7 != null) {
                method85(2, 0, 1, 0, ((Entity) (myPlayer)).smallY[0], 1, 0, ((Entity) (class30_sub2_sub4_sub1_sub1_7)).smallY[0], ((Entity) (myPlayer)).smallX[0], false, ((Entity) (class30_sub2_sub4_sub1_sub1_7)).smallX[0]);
                anInt914 = super.saveClickX;
                anInt915 = super.saveClickY;
                crossType = 2;
                crossIndex = 0;
        ...
        if (l == 244) {
            boolean flag7 = method85(2, 0, 0, 0, ((Entity) (myPlayer)).smallY[0], 0, 0, k, ((Entity) (myPlayer)).smallX[0], false, j);
            if (!flag7) {
                flag7 = method85(2, 0, 1, 0, ((Entity) (myPlayer)).smallY[0], 1, 0, k, ((Entity) (myPlayer)).smallX[0], false, j);
            }
            anInt914 = super.saveClickX;
            anInt915 = super.saveClickY;
            crossType = 2;
    ...
    public final void method70() {
        anInt1251 = 0;
        int j = (((Entity) (myPlayer)).x >> 7) + baseX;
        int k = (((Entity) (myPlayer)).y >> 7) + baseY;
    ...
    public final void build3dScreenMenu() {
        ...
        for (int k = 0; k < Model.anInt1687; k++) {
            ...
            if (k1 == 3) {
                Container class19 = groundArray[plane][i1][j1];
                if (class19 != null) {
    ...
    public final void CleanUpForQuit() {
        ...
        Jagex3DCanvas.nullLoader();
        WorldController.nullLoader();
        Model.nullLoader();
        AnimationHeader.method530();
        System.gc();
    }
                ...
                if (messagePromptRaised) { //messagePromptRaised
                    ...
                    if ((j == 13 || j == 10) && inputString.length() > 0) { //pressed enter or the other enter
                        ...
                        if (inputString.startsWith("::")) { //command
                            ...
                            if (playerRights == 2) {
                                pushMessage(((Entity) (myPlayer)).aString1506, 2, "@cr2@" + Player.name, aBoolean991);
                            } else if (playerRights == 1) {
                                pushMessage(((Entity) (myPlayer)).aString1506, 2, "@cr1@" + Player.name, aBoolean991);
                            } else {
                                pushMessage(((Entity) (myPlayer)).aString1506, 2, Player.name, aBoolean991);
                            }
                            if (publicChatMode == 2) {
                                publicChatMode = 3;
                                needChatAreaRedraw = true;
    ...
    public final void method75(int i, RSInterface class9) {
        ...
        if (j == 327) {
            ...
            if (aBoolean1031) {
                ...
                class30_sub2_sub4_sub6.method470(Animation.anims[((Entity) (myPlayer)).anInt1511].animationFrames[0], 40542);
    ...
    public final void resetImageProducers2() {
        ...
        chatArea = new RSImageProducer(506, 128, getGameComponent());
        minimapArea = new RSImageProducer(250, 168, getGameComponent());
        DrawingArea.clearDrawingArea();
        
        // This fixes an issue during loading?
        CustomMapback.method348(0, 0);

        inventoryArea = new RSImageProducer(192, 261, getGameComponent());
        gameArea = new RSImageProducer(512, 334, getGameComponent());
        DrawingArea.clearDrawingArea();
        bottomChatArea = new RSImageProducer(496, 31, getGameComponent());
        bottomTabArea = new RSImageProducer(269, 37, getGameComponent());
        topTabArea = new RSImageProducer(250, 37, getGameComponent());
    ...
    public final void processRightClick() {
        ...
        hoverSpriteid = 0;
        if (super.mouseX > 4 && super.mouseY > 4 && super.mouseX < 515 && super.mouseY < 339) {
            if (openInterfaceID != -1) {
                buildInterfaceMenu(4, 13037, RSInterface.interfaceCache[openInterfaceID], super.mouseX, 4, super.mouseY, 0);
            } else {
                build3dScreenMenu();
            }
        }
        ...
        if (super.mouseX > 553 && super.mouseY > 205 && super.mouseX < 743 && super.mouseY < 466) { //inventory
            if (invOverlayInterfaceID != -1) { //there is an interface over the incventory = invOverlayInterfaceID
                buildInterfaceMenu(553, 13037, RSInterface.interfaceCache[invOverlayInterfaceID], super.mouseX, 205, super.mouseY, 0);
            } else {
                if (tabInterfaceIDs[tabID] != -1) {
                    buildInterfaceMenu(553, 13037, RSInterface.interfaceCache[tabInterfaceIDs[tabID]], super.mouseX, 205, super.mouseY, 0);
                }
            }
        }
        ...
        if (super.mouseX > 6 && super.mouseY > 344 && super.mouseX < 496 && super.mouseY < 503) { //chatbox
            if (backDialogID != -1) { //there is an interface in the chatbox open = backDialogID
                buildInterfaceMenu(6, 13037, RSInterface.interfaceCache[backDialogID], super.mouseX, 344, super.mouseY, 0);
            } else {
                if (super.mouseY < 463 && super.mouseX < 503) {
                    method74(super.mouseX - 6, super.mouseY - 344, 9);
                }
            }
        }
        ...
        if (super.mouseX >= 515 && super.mouseY >= 0 && super.mouseX <= 765 && super.mouseY <= 167) {
            if (openInterfaceID != -1) {
                buildInterfaceMenu(0, 13037, RSInterface.interfaceCache[openInterfaceID], super.mouseX, 0, super.mouseY, 0);
            }
        }
        if (hoverSpriteid != anInt1026) {
            anInt1026 = hoverSpriteid;
    ...
    private void method86(Packet class30_sub2_sub2) {
        for (int j = 0; j < anInt893; j++) {
            int k = anIntArray894[j];
            NPC class30_sub2_sub4_sub1_sub1 = npcArray[k];
            int l = class30_sub2_sub2.readUnsignedByte();
            ...
            if (anIntArray1250[i] <= 0) {
                ...
                try {
                    if (anIntArray1207[i] == anInt874 && anIntArray1241[i] == anInt1289) {
                        ...
                        Packet class30_sub2_sub2 = Sounds.method241(anIntArray1241[i], anIntArray1207[i]);
    ...
    public final void startUp() {
        ...
        try {
            ...
            AnimationHeader.method528(aClass42_Sub1_1068.getAnimCount());
            ...
            aClass15_903 = new RSImageProducer(class30_sub2_sub1_sub1.myWidth, class30_sub2_sub1_sub1.myHeight, getGameComponent());
            class30_sub2_sub1_sub1.method346(0, 0);

            class30_sub2_sub1_sub1 = new Sprite(class44_2, "backleft2", 0); //left chat border
            aClass15_904 = new RSImageProducer(8, 134, getGameComponent());
            class30_sub2_sub1_sub1.method346(0, 0);

            class30_sub2_sub1_sub1 = new Sprite(class44_2, "backhmid2", 0); //chat top border
            aClass15_911 = new RSImageProducer(555, 6, getGameComponent());
            class30_sub2_sub1_sub1.method346(0, 0);
            ...
            aClass15_906 = new RSImageProducer(class30_sub2_sub1_sub1.myWidth, class30_sub2_sub1_sub1.myHeight, getGameComponent());
            class30_sub2_sub1_sub1.method346(0, 0);

            class30_sub2_sub1_sub1 = new Sprite(class44_2, "backtop1", 0);
            aClass15_907 = new RSImageProducer(class30_sub2_sub1_sub1.myWidth, class30_sub2_sub1_sub1.myHeight, getGameComponent());
            class30_sub2_sub1_sub1.method346(0, 0);
            ...
            aClass15_909 = new RSImageProducer(class30_sub2_sub1_sub1.myWidth, class30_sub2_sub1_sub1.myHeight, getGameComponent());
            class30_sub2_sub1_sub1.method346(0, 0);

            class30_sub2_sub1_sub1 = new Sprite(class44_2, "backvmid3", 0); //left pillar bottom
            aClass15_910 = new RSImageProducer(39, 122, getGameComponent());
            class30_sub2_sub1_sub1.method346(0, 0);
            ...
            Jagex3DCanvas.method368(class44_3);
            Jagex3DCanvas.method372(0.80000000000000004D);
            Jagex3DCanvas.method367(20);
            ...
            Jagex3DCanvas.method365(-950, 506, 128);
            anIntArray1180 = Jagex3DCanvas.anIntArray1472;
            Jagex3DCanvas.method365(-950, 192, 261);
            anIntArray1181 = Jagex3DCanvas.anIntArray1472;
            Jagex3DCanvas.method365(-950, 512, 334);
            anIntArray1182 = Jagex3DCanvas.anIntArray1472;
            int ai[] = new int[9];
            for (int i8 = 0; i8 < 9; i8++) {
                int k8 = 128 + i8 * 32 + 15;
                int l8 = 600 + k8 * 3;
                int i9 = Jagex3DCanvas.anIntArray1470[k8];
                ai[i8] = l8 * i9 >> 16;
            }
    ...
    private void method91(Packet stream, int i) {
        while (stream.bitPosition + 10 < i * 8) {
            ...
            class30_sub2_sub4_sub1_sub2.setPos(((Entity) (myPlayer)).smallX[0] + j1, ((Entity) (myPlayer)).smallY[0] + i1, l == 1);
        }
    ...
    public final void processMainScreenClick() {
        ...
        if (super.clickMode3 == 1) {
            ...
            if (i >= 0 && j >= 0 && i < 146 && j < 151) {
                ...
                int i1 = Jagex3DCanvas.anIntArray1470[k];
                int j1 = Jagex3DCanvas.anIntArray1471[k];
                i1 = i1 * (minimapInt3 + 256) >> 8;
                j1 = j1 * (minimapInt3 + 256) >> 8;
                int k1 = j * i1 + i * j1 >> 11;
                int l1 = j * j1 - i * i1 >> 11;
                int i2 = ((Entity) (myPlayer)).x + k1 >> 7;
                int j2 = ((Entity) (myPlayer)).y - l1 >> 7;
                boolean flag1 = method85(1, 0, 0, 0, ((Entity) (myPlayer)).smallY[0], 0, 0, j2, ((Entity) (myPlayer)).smallX[0], true, i2);
                if (flag1) {
                    stream.writeWordBigEndian(i);
                    ...
                    stream.writeWord(((Entity) (myPlayer)).x);
                    stream.writeWord(((Entity) (myPlayer)).y);
    ...
    public final void method98(Entity class30_sub2_sub4_sub1, byte byte0) {
        if (class30_sub2_sub4_sub1.anInt1548 == loopCycle || class30_sub2_sub4_sub1.anim == -1 || class30_sub2_sub4_sub1.anInt1529 != 0 || class30_sub2_sub4_sub1.anInt1528 + 1 > Animation.anims[class30_sub2_sub4_sub1.anim].getAnimationDelay(class30_sub2_sub4_sub1.anInt1527)) {
    ...
    public final void method101(Entity class30_sub2_sub4_sub1, int i) {
        ...
        if (class30_sub2_sub4_sub1.anInt1517 != -1) {
            ...
            if (class30_sub2_sub4_sub1.anInt1518 < class20.frameCount && class30_sub2_sub4_sub1.anInt1519 > class20.getAnimationDelay(class30_sub2_sub4_sub1.anInt1518)) {
        ...
        if (class30_sub2_sub4_sub1.anInt1520 != -1 && loopCycle >= class30_sub2_sub4_sub1.anInt1523) {
            ...
            for (class30_sub2_sub4_sub1.anInt1522++; class30_sub2_sub4_sub1.anInt1521 < class20_1.frameCount && class30_sub2_sub4_sub1.anInt1522 > class20_1.getAnimationDelay(class30_sub2_sub4_sub1.anInt1521); class30_sub2_sub4_sub1.anInt1521++) {
                class30_sub2_sub4_sub1.anInt1522 -= class20_1.getAnimationDelay(class30_sub2_sub4_sub1.anInt1521);
            }
        ...
        if (class30_sub2_sub4_sub1.anim != -1 && class30_sub2_sub4_sub1.anInt1529 == 0) {
            ...
            for (class30_sub2_sub4_sub1.anInt1528++; class30_sub2_sub4_sub1.anInt1527 < class20_3.frameCount && class30_sub2_sub4_sub1.anInt1528 > class20_3.getAnimationDelay(class30_sub2_sub4_sub1.anInt1527); class30_sub2_sub4_sub1.anInt1527++) {
                class30_sub2_sub4_sub1.anInt1528 -= class20_3.getAnimationDelay(class30_sub2_sub4_sub1.anInt1527);
            }
    ...
    public final void drawGameScreen() {
        ...
        if (backDialogID == -1) {
            ...
            if (super.mouseX > 448 && super.mouseX < 560 && super.mouseY > 332) { //mousex and mousey?? (in chat scroll??)
                method65(482, 112, super.mouseX - 17, super.mouseY - 357, chatBoxScrollbar, 0, false, scrollPos, 0);
            }
        ...
        if (tabAreaAltered) {
            ...
            if (invOverlayInterfaceID == -1) {
                ...
                if (super.mouseX >= 524 && super.mouseX <= 561 && super.mouseY >= 168 && super.mouseY < 204 && tabInterfaceIDs[0] != -1) { //rt
                    if (tabID == 0) {
                        rtch.method348(7, 0);
                    } else {
                        rth.method348(7, 0);
                ...
                if (super.mouseX >= 562 && super.mouseX <= 594 && super.mouseY >= 168 && super.mouseY < 204 && tabInterfaceIDs[1] != -1) {
                    if (tabID == 1) {
                        nch.method348(46, 0);
                    } else {
                        nh.method348(46, 0);
                ...
                if (super.mouseX >= 595 && super.mouseX <= 627 && super.mouseY >= 168 && super.mouseY < 204 && tabInterfaceIDs[2] != -1) {
                    if (tabID == 2) {
                        nch.method348(79, 0);
                    } else {
                        nh.method348(79, 0);
                ...
                if (super.mouseX >= 628 && super.mouseX <= 660 && super.mouseY >= 168 && super.mouseY < 204 && tabInterfaceIDs[3] != -1) {
                    if (tabID == 3) {
                        nch.method348(112, 0);
                    } else {
                        nh.method348(112, 0);
                ...
                if (super.mouseX >= 661 && super.mouseX <= 693 && super.mouseY >= 168 && super.mouseY < 204 && tabInterfaceIDs[4] != -1) {
                    if (tabID == 4) {
                        nch.method348(145, 0);
                    } else {
                        nh.method348(145, 0);
                ...
                if (super.mouseX >= 694 && super.mouseX <= 726 && super.mouseY >= 168 && super.mouseY < 204 && tabInterfaceIDs[5] != -1) {
                    if (tabID == 5) {
                        nch.method348(178, 0);
                    } else {
                        nh.method348(178, 0);
                ...
                if (super.mouseX >= 727 && super.mouseX <= 763 && super.mouseY >= 168 && super.mouseY < 205 && tabInterfaceIDs[6] != -1) {
                    if (tabID == 6) {
            ...
            if (invOverlayInterfaceID == -1) {
                ...
                if (super.mouseX >= 524 && super.mouseX <= 561 && super.mouseY >= 467 && super.mouseY < 503 && tabInterfaceIDs[7] != -1) {
                    if (tabID == 7) {
                        rbch.method348(28, 0);
                    } else {
                        rbh.method348(28, 0);
                ...
                if (super.mouseX >= 562 && super.mouseX <= 594 && super.mouseY >= 467 && super.mouseY < 503 && tabInterfaceIDs[8] != -1) {
                    if (tabID == 8) {
                        nch.method348(66, 0);
                    } else {
                        nh.method348(66, 0);
                ...
                if (super.mouseX >= 595 && super.mouseX <= 627 && super.mouseY >= 467 && super.mouseY < 503 && tabInterfaceIDs[9] != -1) {
                    if (tabID == 9) {
                        nch.method348(99, 0);
                    } else {
                        nh.method348(99, 0);
                ...
                if (super.mouseX >= 628 && super.mouseX <= 660 && super.mouseY >= 467 && super.mouseY < 503 && tabInterfaceIDs[10] != -1) {
                    if (tabID == 14) {
                        nch.method348(132, 0);
                    } else {
                        nh.method348(132, 0);
                ...
                if (super.mouseX >= 661 && super.mouseX <= 693 && super.mouseY >= 467 && super.mouseY < 503 && tabInterfaceIDs[11] != -1) {
                    if (tabID == 11) {
                        nch.method348(165, 0);
                    } else {
                        nh.method348(165, 0);
                ...
                if (super.mouseX >= 694 && super.mouseX <= 726 && super.mouseY >= 467 && super.mouseY < 503 && tabInterfaceIDs[12] != -1) {
                    if (tabID == 12) {
                        nch.method348(198, 0);
                    } else {
                        nh.method348(198, 0);
                ...
                if (super.mouseX >= 727 && super.mouseX <= 763 && super.mouseY >= 467 && super.mouseY < 503 && tabInterfaceIDs[13] != -1) {
                    if (tabID == 13) {
    ...
    public final void method105(int j, int k, RSInterface class9, int l) {
        ...
        DrawingArea.createDrawingArea(k, l, k + class9.width, l + class9.height);
        ...
        for (int j2 = 0; j2 < i2; j2++) {
            ...
            if (class9_1.interfaceType == 0) {
                ...
                if (class9_1.interfaceType == 2) {
                    ...
                    int k3 = Jagex3DCanvas.textureInt1;
                    int j4 = Jagex3DCanvas.textureInt2;
                    Jagex3DCanvas.textureInt1 = k2 + class9_1.width / 2;
                    Jagex3DCanvas.textureInt2 = l2 + class9_1.height / 2;
                    int i5 = Jagex3DCanvas.anIntArray1470[class9_1.modelRotationY] * class9_1.modelZoom >> 16;
                    int l5 = Jagex3DCanvas.anIntArray1471[class9_1.modelRotationY] * class9_1.modelZoom >> 16;
                    ...
                    if (i7 == -1) {
                        ...
                        class30_sub2_sub4_sub6 = class9_1.getAnimatedModel(class20.anIntArray354[class9_1.animationLength], class20.animationFrames[class9_1.animationLength], flag2);
                    }
                    if (class30_sub2_sub4_sub6 != null) {
                        class30_sub2_sub4_sub6.method482(0, class9_1.modelRotationX, 0, class9_1.modelRotationY, 0, i5, l5);
                    }
                    Jagex3DCanvas.textureInt1 = k3;
                    Jagex3DCanvas.textureInt2 = j4;
        ...
        DrawingArea.createDrawingArea(i1, j1, k1, l1);
    }
    ...
    private void method107(int i, int j, Packet class30_sub2_sub2, byte byte0, Player class30_sub2_sub4_sub1_sub2) {
        if (byte0 != 25) {
            groundArray = null;
        }
        if ((i & 0x400) != 0) {
        ...
        if ((i & 4) != 0) {
            ...
            if (((Entity) (class30_sub2_sub4_sub1_sub2)).aString1506.charAt(0) == '~') {
                ...
                pushMessage(((Entity) (class30_sub2_sub4_sub1_sub2)).aString1506, 2, Player.name, aBoolean991);
        ...
        if ((i & 0x10) != 0) {
            ...
            Packet class30_sub2_sub2_1 = new Packet(abyte0);
    ...
    public final void method108() {
        try {
            int j = ((Entity) (myPlayer)).x + anInt1278;
            int k = ((Entity) (myPlayer)).y + anInt1131;
            ...
            signlink.reportError("glfc_ex " + ((Entity) (myPlayer)).x + "," + ((Entity) (myPlayer)).y + "," + anInt1014 + "," + anInt1015 + "," + anInt1069 + "," + anInt1070 + "," + baseX + "," + baseY);
            throw new RuntimeException("eek");
        }
    }
    ...
    private final void method117(Packet class30_sub2_sub2, int i, byte byte0) {
        ...
        if (k == 1) {
            ...
            myPlayer.moveInDir(false, (byte) 20, l);
            int k1 = class30_sub2_sub2.readBits(1);
            if (k1 == 1) {
                anIntArray894[anInt893++] = maxPlayersIndex;
            }
        ...
        if (k == 2) {
            ...
            myPlayer.moveInDir(true, (byte) 20, i1);
            int l1 = class30_sub2_sub2.readBits(3);
            myPlayer.moveInDir(true, (byte) 20, l1);
        ...
        for (int k = 0; k < class9.children.length; k++) {
            ...
            if (class9_1.interfaceType == 6 && (class9_1.disabledAnimation != -1 || class9_1.enabledAnimation != -1)) {
                ...
                if (l != -1) {
                    ...
                    for (class9_1.animationDelay += i; class9_1.animationDelay > class20.getAnimationDelay(class9_1.animationLength);) {
                        class9_1.animationDelay -= class20.getAnimationDelay(class9_1.animationLength) + 1;
                        class9_1.animationLength++;
                        if (class9_1.animationLength >= class20.frameCount) {
                            class9_1.animationLength -= class20.anInt356;
    ...
    public final int method120(int i) {
        ...
        if (yCameraCurve < 310) {
            int k = xCameraPos >> 7;
            int l = yCameraPos >> 7;
            int i1 = ((Entity) (myPlayer)).x >> 7;
            int j1 = ((Entity) (myPlayer)).y >> 7;
        ...
        if ((byteGroundArray[plane][((Entity) (myPlayer)).x >> 7][((Entity) (myPlayer)).y >> 7] & 4) != 0) {
            j = plane;
        }
        return j;
    }
    ...
    public final int extractInterfaceValues(RSInterface class9, int j) {
        ...
        try {
            ...
            do {
                ...
                if (j1 == 18) {
                    k1 = (((Entity) (myPlayer)).x >> 7) + baseX;
                }
                if (j1 == 19) {
                    k1 = (((Entity) (myPlayer)).y >> 7) + baseY;
                }
                if (j1 == 20) {
                    k1 = ai[l++];
                }
    ...
    public final void drawMiniMap() {
        ...
        int j = 48 + ((Entity) (myPlayer)).x / 32;
        int l2 = 464 - ((Entity) (myPlayer)).y / 32;
        ...
        for (int j5 = 0; j5 < anInt1071; j5++) { //your dot??
            int k = (anIntArray1072[j5] * 4 + 2) - ((Entity) (myPlayer)).x / 32;
            int i3 = (anIntArray1073[j5] * 4 + 2) - ((Entity) (myPlayer)).y / 32;
            markMinimap(aClass30_Sub2_Sub1_Sub1Array1140[j5], k, i3, false);
        }

        for (int k5 = 0; k5 < 104; k5++) { //items
            for (int l5 = 0; l5 < 104; l5++) {
                Container class19 = groundArray[plane][k5][l5];
                if (class19 != null) {
                    int l = (k5 * 4 + 2) - ((Entity) (myPlayer)).x / 32;
                    int j3 = (l5 * 4 + 2) - ((Entity) (myPlayer)).y / 32;
        ...
        for (int i6 = 0; i6 < npcCount; i6++) { //NPC's
            ...
            if (class30_sub2_sub4_sub1_sub1 != null && class30_sub2_sub4_sub1_sub1.isVisible()) {
                ...
                if (class5 != null && class5.aBoolean87 && class5.aBoolean84) {
                    int i1 = ((Entity) (class30_sub2_sub4_sub1_sub1)).x / 32 - ((Entity) (myPlayer)).x / 32;
                    int k3 = ((Entity) (class30_sub2_sub4_sub1_sub1)).y / 32 - ((Entity) (myPlayer)).y / 32;
        ...
        for (int j6 = 0; j6 < anInt891; j6++) { //players
            ...
            if (class30_sub2_sub4_sub1_sub2 != null && class30_sub2_sub4_sub1_sub2.isVisible()) {
                int j1 = ((Entity) (class30_sub2_sub4_sub1_sub2)).x / 32 - ((Entity) (myPlayer)).x / 32;
                int l3 = ((Entity) (class30_sub2_sub4_sub1_sub2)).y / 32 - ((Entity) (myPlayer)).y / 32;
                boolean flag1 = false;
        ...
        if (anInt855 != 0 && loopCycle % 20 < 10) { //arrows?
            if (anInt855 == 1 && anInt1222 >= 0 && anInt1222 < npcArray.length) {
                ...
                if (class30_sub2_sub4_sub1_sub1_1 != null) {
                    int k1 = ((Entity) (class30_sub2_sub4_sub1_sub1_1)).x / 32 - ((Entity) (myPlayer)).x / 32;
                    int i4 = ((Entity) (class30_sub2_sub4_sub1_sub1_1)).y / 32 - ((Entity) (myPlayer)).y / 32;
                    drawMinimapArrow(mapMarker, i4, k1);
                }
            }
            if (anInt855 == 2) {
                int l1 = ((anInt934 - baseX) * 4 + 2) - ((Entity) (myPlayer)).x / 32;
                int j4 = ((anInt935 - baseY) * 4 + 2) - ((Entity) (myPlayer)).y / 32;
            ...
            if (anInt855 == 10 && anInt933 >= 0 && anInt933 < playerArray.length) {
                ...
                if (class30_sub2_sub4_sub1_sub2_1 != null) {
                    int i2 = ((Entity) (class30_sub2_sub4_sub1_sub2_1)).x / 32 - ((Entity) (myPlayer)).x / 32;
                    int k4 = ((Entity) (class30_sub2_sub4_sub1_sub2_1)).y / 32 - ((Entity) (myPlayer)).y / 32;
        ...
        if (destX != 0) { //should we draw the flag???
            int j2 = (destX * 4 + 2) - ((Entity) (myPlayer)).x / 32;
            int l4 = (destY * 4 + 2) - ((Entity) (myPlayer)).y / 32;
    ...
    public final void method128(int i, int j, int k, int l) {
        ...
        i1 = j2;
        if (l >= 50) {
            spriteDrawX = Jagex3DCanvas.textureInt1 + (i << 9) / l;
            spriteDrawY = Jagex3DCanvas.textureInt2 + (i1 << 9) / l;
            return;
        } else {
            spriteDrawX = -1;
            spriteDrawY = -1;
    ...
    private final void method134(byte byte0, int i, Packet class30_sub2_sub2) {
    ...
    public final void drawLoginScreen(boolean flag) {
        ...
        if (showWorld) {
            ...
            if (super.mouseX >= 690 && super.mouseX <= 762 && super.mouseY >= 5 && super.mouseY <= 20) {
            ...
            for (int i = 0; i < worlds.length; i++) {
                ...
                if (super.mouseY >= down && super.mouseY < down + 20) { //hover line
                ...
                if (super.clickMode3 == 1 && super.mouseY >= down && super.mouseY < down + 20 && super.mouseX <= 245) {
                    showWorld = false;
                    server = sIP;
                    port = sPort;
                }
                if (super.mouseY >= down && super.mouseY < down + 20 && super.mouseX > 245 && super.mouseX < 460) {
                ...
                if (super.clickMode3 == 1 && super.mouseY >= down && super.mouseY < down + 20 && super.mouseX >= 460) {
                    showWorld = false;
                    server = sIP;
                    port = sPort;
                }
            ...
            if (super.mouseX >= 5 && super.mouseX <= 90 && super.mouseY >= 475 && super.mouseY <= 498) {
            ...
            //exit button
            if (super.mouseX >= 740 && super.mouseX <= 756 && super.mouseY >= 11 && super.mouseY <= 27) {
                //login button hover
            ...
            if (flag) { //logging in
                ...
                if (super.mouseX >= 504 && super.mouseX <= 743 && super.mouseY >= 165 && super.mouseY <= 204) { //hovering
    ...
    public final void processLoginScreenInput() {
        ...
        if (showWorld) {
            if (super.clickMode3 == 1 && super.saveClickX >= 690 && super.saveClickX <= 762 && super.saveClickY >= 5 && super.saveClickY <= 20) { //cancel
                closeCheckServers();
                showWorld = false;
            }
        } else {

            if (super.clickMode3 == 1 && super.saveClickX >= 5 && super.saveClickX <= 90 && super.saveClickY >= 475 && super.saveClickY <= 498) { //server select
                processWorlds();
                showWorld = true;
                
            }

            if (super.clickMode3 == 1 && super.saveClickX >= 740 && super.saveClickX <= 756 && super.saveClickY >= 11 && super.saveClickY <= 27) { //exit
                Csettings.exitWarningDialog();
            }



            if (super.clickMode3 == 1 && super.saveClickX >= 542 && super.saveClickX <= 748 && super.saveClickY >= 35 && super.saveClickY <= 61) { //username
                anInt1216 = 0;
            }

            if (super.clickMode3 == 1 && super.saveClickX >= 543 && super.saveClickX <= 748 && super.saveClickY >= 67 && super.saveClickY <= 93) { //password
                anInt1216 = 1;
            }

            if (super.clickMode3 == 1 && super.saveClickX >= 660 && super.saveClickX <= 731 && super.saveClickY >= 102 && super.saveClickY <= 115) { //save
                if (saveUser) {
                    saveUser = false;
                } else {
                    saveUser = true;
            ...
            if (super.clickMode3 == 1 && super.saveClickX >= 504 && super.saveClickX <= 743 && super.saveClickY >= 165 && super.saveClickY <= 204) { //login button
    ...
    public final void method137(Packet stream, int j) {
        if (j == 84) {
            ...
            if (j3 >= 0 && i6 >= 0 && j3 < 104 && i6 < 104) {
                Container class19_1 = groundArray[plane][j3][i6];
                if (class19_1 != null) {
        ...
        if (j == 105) {
            ...
            int i14 = l11 >> 4 & 0xf;
            int i16 = l11 & 7;
            if (((Entity) (myPlayer)).smallX[0] >= k3 - i14 && ((Entity) (myPlayer)).smallX[0] <= k3 + i14 && ((Entity) (myPlayer)).smallY[0] >= j6 - i14 && ((Entity) (myPlayer)).smallY[0] <= j6 + i14 && aBoolean848 && !lowMem && anInt1062 < 50) {
        ...
        if (j == 215) {
            ...
            if (k6 >= 0 && j9 >= 0 && k6 < 104 && j9 < 104 && i12 != unknownInt10) {
                ...
                if (groundArray[plane][k6][j9] == null) {
                    groundArray[plane][k6][j9] = new Container();
                }
        ...
        if (j == 156) {
            ...
            if (i4 >= 0 && l6 >= 0 && i4 < 104 && l6 < 104) {
                Container class19 = groundArray[plane][i4][l6];
                if (class19 != null) {
                    for (Item class30_sub2_sub4_sub2 = (Item) class19.reverseGetFirst(); class30_sub2_sub4_sub2 != null; class30_sub2_sub4_sub2 = (Item) class19.reverseGetNext()) {
        ...
        if (j == 44) {
            ...
            if (l10 >= 0 && i13 >= 0 && l10 < 104 && i13 < 104) {
                ...
                if (groundArray[plane][l10][i13] == null) {
                    groundArray[plane][l10][i13] = new Container();
                }
    ...
    public static void setLowMem() {
        ...
        Jagex3DCanvas.lowMem = true;
        lowMem = true;
        Map.lowMem = true;
        ObjectDef.lowMem = true;
    }

    private void method139(Packet stream) {
    ...
    private final void method143(int i, Packet class30_sub2_sub2, int j) {
        anInt839 = 0;
        if (j != 9759) {
            pktType = class30_sub2_sub2.readUnsignedByte();
        }
    ...
    public final void loadWorld() {
        ...
        if (!aBoolean1160) {
            ...
            setCameraPos(CameraPos2 + i * CameraPos1, i, anInt1014, method42(plane, ((Entity) (myPlayer)).y, true, ((Entity) (myPlayer)).x) - 50, k, anInt1015);
        }
        int j;
        if (!aBoolean1160) {
            j = method120(111);
        ...
        int k2 = Jagex3DCanvas.anInt1481;
