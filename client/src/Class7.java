	...
	||##########################################################||
	||#           File: Class7.java - ObjectManager            #||
	\*##########################################################*/
...
final class Class7 {
							...
							if(l18 > 0 || i19 > 0) {
								...
								if(i19 == 0) {
									...
									if(i23 >= 0) {
										...
										if(class22_2.groundColor == 0xff00ff) {
										k23 = 0;
										j23 = -2;
										i23 = -1;
										} else {
	...
	public static final void method188(WorldController class25, int i, int j, int k, int l, Class11 class11, int ai[][][], int i1,
