...
public class BZ2InputStream {
    ...
    public static BZ2Block bz2Block = new BZ2Block();

    public static byte method67(BZ2Block class5) {
        return (byte) method74(8, class5);
    }

    public static void method68(BZ2Block class5) {
        int k8 = 0;
        int ai[] = null;
        int ai1[] = null;
        int ai2[] = null;
        class5.anInt69 = 1;
        if (BZ2Block.anIntArray78 == null) {
            BZ2Block.anIntArray78 = new int[class5.anInt69 * 0x186a0];
        }
        boolean flag20 = true;
        while (flag20) {
            ...
            for (int k5 = ai2[l7 - ai1[i7]]; k5 != l4;) {
                if (k5 == 0 || k5 == 1) {
                    ...
                    for (; j6 > 0; j6--) {
                        BZ2Block.anIntArray78[i6] = byte5 & 0xff;
                        i6++;
                    }
                } else {
                    int j11 = k5 - 1;
                    ...
                    BZ2Block.anIntArray78[i6] = class5.aByteArray82[byte6 & 0xff] & 0xff;
                    i6++;
                    if (j5 == 0) {
                        i5++;
                        j5 = 50;
            ...
            for (int l2 = 0; l2 < i6; l2++) {
                byte byte7 = (byte) (BZ2Block.anIntArray78[l2] & 0xff);
                BZ2Block.anIntArray78[class5.anIntArray76[byte7 & 0xff]] |= l2 << 8;
                class5.anIntArray76[byte7 & 0xff]++;
            }
            class5.anInt72 = BZ2Block.anIntArray78[class5.anInt71] >> 8;
            class5.anInt75 = 0;
            class5.anInt72 = BZ2Block.anIntArray78[class5.anInt72];
    ...
    public static void method70(BZ2Block class5) {
        class5.anInt79 = 0;
        for (int i = 0; i < 256; i++) {
    ...
    public static byte method71(BZ2Block class5) {
    ...
    public static int decompressBuffer(byte abyte0[], int i, byte abyte1[], int j, int k) {
        synchronized (bz2Block) {
            bz2Block.aByteArray54 = abyte1;
            bz2Block.anInt55 = k;
            bz2Block.aByteArray59 = abyte0;
            bz2Block.anInt60 = 0;
            bz2Block.anInt56 = j;
            bz2Block.anInt61 = i;
            bz2Block.anInt68 = 0;
    ...
    public static int method74(int i, BZ2Block class5) {
        int j;
        do {
            if (class5.anInt68 >= i) {
