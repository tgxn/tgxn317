...
public class Main extends RSApplet {
	...
	public static void main(String args[]) {
		Main applet_sub1_sub1 = new Main();
		applet_sub1_sub1.createFrame(765, 503);
	}
	...
	public void startUp() {
		...
		try {
			for(int l = 0; l < 100; l++)
				mapScenesArray[l] = new Class1_Sub1_Sub1_Sub3(class6, "mapscene", l);
		} catch(Exception _ex) { }
		
		try {
			for(int i1 = 0; i1 < 100; i1++)
				mapFunctionsArray[i1] = new Class1_Sub1_Sub1_Sub2(class6, "mapfunction", i1);
		} catch(Exception _ex) { }
		
		normalFont = new Class1_Sub1_Sub1_Sub4(class6, "b12_full", false);
		
		
		//labels - fonts
		aSprite_126 = new Sprite(11, this);
		aSprite_127 = new Sprite(12, this);
		aSprite_128 = new Sprite(14, this);
		aSprite_129 = new Sprite(17, this);
		aSprite_130 = new Sprite(19, this);
		aSprite_131 = new Sprite(22, this);
		aSprite_132 = new Sprite(26, this);
		aSprite_133 = new Sprite(30, this); //large font
		...
		worldOverviewSprite = new Class1_Sub1_Sub1_Sub2(overviewWidth, overviewHeight);
	...
	public Class6 readDAT() {
		byte abyte0[] = null;
		try {
			abyte0 = FileOperations.ReadFile("worldmap.dat");
	...
	public Main() {
		...
		needToDraw = true;
		mapScenesArray = new Class1_Sub1_Sub1_Sub3[100]; //
		mapFunctionsArray = new Class1_Sub1_Sub1_Sub2[100];
	...
	public Class1_Sub1_Sub1_Sub2 mapFunctionsArray[];
	public Class1_Sub1_Sub1_Sub3 mapScenesArray[];
	public Class1_Sub1_Sub1_Sub4 normalFont;
	...
	public Class1_Sub1_Sub1_Sub2 worldOverviewSprite;
