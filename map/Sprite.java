...
public class Sprite extends DrawingArea {
	...
	public void method36(Font font, FontMetrics fontmetrics, char c, int i, boolean bool, RSApplet applet) {
	...
	public Sprite(int fontPT, RSApplet applet_sub1) {
		aBoolean198 = false;
		anInt199 = 0;
		...
		for(int j = 0; j < 95; j++)
			method36(font, fontmetrics, "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"\243$%^&*()-_=+[{]};:'@#~,<.>/?\\| ".charAt(j), j, false, applet_sub1);
		...
		if(aBoolean198) {
			...
			for(int k = 0; k < 95; k++)
				method36(font1, fontmetrics1, "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"\243$%^&*()-_=+[{]};:'@#~,<.>/?\\| ".charAt(k), k, false, applet_sub1);

			if(!aBoolean198) {
				anInt199 = 855;
				aBoolean198 = false;
				for(int l = 0; l < 95; l++)
					method36(font1, fontmetrics1, "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"\243$%^&*()-_=+[{]};:'@#~,<.>/?\\| ".charAt(l), l, true, applet_sub1);

			}
		}
		byte abyte0[] = new byte[anInt199];
		for(int i1 = 0; i1 < anInt199; i1++)
			abyte0[i1] = byteArrayofPixels[i1];
