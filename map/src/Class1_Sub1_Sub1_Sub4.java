...
public class Class1_Sub1_Sub1_Sub4 extends DrawingArea {
	...
	public Class1_Sub1_Sub1_Sub4(Class6 class6, String s, boolean flag) {
	...
	public void method55(String s, int i, int j, int k) {
