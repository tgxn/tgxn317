...
public final class JagexFileSystem {
    ...
    public JagexFileSystem(int i, RandomAccessFile randomaccessfile, RandomAccessFile randomaccessfile1, int j, boolean flag) {
        anInt306 = 923;
        aBoolean307 = true;
        anInt312 = 65000;
        anInt311 = j;
    ...
    public synchronized byte[] decompress(boolean flag, int i) {
        if (!flag) {
            throw new NullPointerException();
        }
        try {
            seekTo(indexFile, -660, i * 6);
            int l;
            for (int j = 0; j < 6; j += l) {
