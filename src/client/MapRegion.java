...
final class MapRegion {
    ...
    public MapRegion(byte abyte0[][][], int i, int j, int k, int ai[][][]) {
        aBoolean132 = true;
        aBoolean143 = false;
        anInt150 = -53;
        anInt145 = 99;
    ...
    public final void method171(TileSetting aclass11[], WorldController class25, int i) {
        for (int j = 0; j < 4; j++) {
            for (int k = 0; k < 104; k++) {
                        ...
                        if (k17 >= 1 && k17 < anInt147 - 1 && (!lowMem || (aByteArrayArrayArray149[0][l6][k17] & 2) != 0 || (aByteArrayArrayArray149[l][l6][k17] & 0x10) == 0 && method182(k17, l, l6, 0) == anInt131)) {
                            ...
                            if (l18 > 0 || i19 > 0) {
                                ...
                                if (i19 == 0) {
                                    ...
                                    int k23;
                                    if (i23 >= 0) {
                                        k23 = Rasterizer.getAverageTextureColour(i23);
                                        j23 = -1;
                                        ...
                                        k23 = Rasterizer.hsl2rgb[method185(class22_2.mapColor, 96)];
                                    }
    ...
    private final void method175(int i, WorldController class25, TileSetting class11, int j, int k, int l, int i1,
            boolean flag, int j1) {
                    ...
                    if (class30_sub2_sub4_sub6 != null) {
                        for (int j5 = 0; j5 <= j4; j5++) {
                            for (int k5 = 0; k5 <= l4; k5++) {
                                int l5 = class30_sub2_sub4_sub6.diagonal2DAboveorigin / 4;
                                if (l5 > 30) {
                                    l5 = 30;
                                }
    ...
    public final void method179(int i, int j, TileSetting aclass11[], int k, int l, int i1, byte abyte0[],
    ...
    public final void method180(byte abyte0[], int i, int j, int k, int l, byte byte0, TileSetting aclass11[]) {
    ...
    private void method181(int i, int j, Stream class30_sub2_sub2, int k, int l, int i1, int j1,
            int k1) {
        j1 = 36 / j1;
    ...
    public final void method183(TileSetting aclass11[], WorldController class25, int i, int j, int k, boolean flag, int l,
    ...
    public static void method188(WorldController class25, int i, int j, int k, int l, TileSetting class11, int ai[][][], int i1, int j1, int k1) {
        int l1 = ai[l][i1][j];
        int i2 = ai[l][i1 + 1][j];
    ...
    public static final boolean method189(int i, byte[] is, int i_250_, int i_251_) {
        ...
        boolean bool = true;
        Stream class30_sub2_sub2 = new Stream(is);
        int i_252_ = -1;
        for (;;) {
    ...
    public final void method190(int i, TileSetting aclass11[], int j, int k, WorldController class25, byte abyte0[]) {
        label0:
        {
            if (k < 7 || k > 7) {
                return;
