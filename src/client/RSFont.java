...
public final class RSFont extends DrawingArea {
    ...
    public RSFont(boolean flag, String string, StreamLoader streamLoader) {
        ...
        Stream fontStream = new Stream(streamLoader.getDataForName(string + ".dat"));
    ...
    public void drawTextWithShadowAndEffects(String string, int drawX, int drawY, int color, boolean shaded) {
        ...
        if (strikeThrough) {
            DrawingArea.method339(drawY + (int) ((double) basicCharSetHeight * 0.69999999999999996D), 0x800000, drawX - startX, startX);
        }
    }
