...
public final class Sprite extends DrawingArea {
    ...
    public Sprite(Component component) {
        try {
            String s = client.sign.Signlink.findCacheDIR() + "sprites/titlescreen/background.png";
            File fcheck = new File(s);
            if (!fcheck.exists()) {
                s = client.sign.Signlink.findCacheDIR() + "sprites/misc/error.png";
            }
    ...
    public Sprite(JagexArchive class44, String s, int i) {
        ...
        if (s.startsWith("backleft2")) {
            try {
                Image image = Toolkit.getDefaultToolkit().getImage(client.sign.Signlink.findCacheDIR() + "sprites/gameframe/borderchatleft.png");
                myWidth = 8;
                myHeight = 134;
                myPixels = new int[myWidth * myHeight];
                PixelGrabber pixelgrabber = new PixelGrabber(image, 0, 0, myWidth, myHeight, myPixels, 0, myWidth);
            ...
            try {
                Image image = Toolkit.getDefaultToolkit().getImage(client.sign.Signlink.findCacheDIR() + "sprites/gameframe/bottomopt.png");
                myPixels = new int[myWidth * myHeight];
                PixelGrabber pixelgrabber = new PixelGrabber(image, 0, 0, myWidth, myHeight, myPixels, 0, myWidth);
                pixelgrabber.grabPixels();
            } catch (Exception exception) {
            ...
            try {
                Image image = Toolkit.getDefaultToolkit().getImage(client.sign.Signlink.findCacheDIR() + "sprites/gameframe/bottomtabs.png");
                myPixels = new int[myWidth * myHeight];
                PixelGrabber pixelgrabber = new PixelGrabber(image, 0, 0, myWidth, myHeight, myPixels, 0, myWidth);
                pixelgrabber.grabPixels();
            } catch (Exception exception) {
            ...
            try {
                Image image = Toolkit.getDefaultToolkit().getImage(client.sign.Signlink.findCacheDIR() + "sprites/gameframe/toptabs.png");
                myPixels = new int[myWidth * myHeight];
                PixelGrabber pixelgrabber = new PixelGrabber(image, 0, 0, myWidth, myHeight, myPixels, 0, myWidth);
                pixelgrabber.grabPixels();
            } catch (Exception exception) {
            ...
            try {
                Image image = Toolkit.getDefaultToolkit().getImage(client.sign.Signlink.findCacheDIR() + "sprites/gameframe/chattopborder.png");
                myWidth = 555;
                myHeight = 6;
                myPixels = new int[myWidth * myHeight];
                PixelGrabber pixelgrabber = new PixelGrabber(image, 0, 0, myWidth, myHeight, myPixels, 0, myWidth);
            ...
            try {
                Image image = Toolkit.getDefaultToolkit().getImage(client.sign.Signlink.findCacheDIR() + "sprites/gameframe/borderleft.png");
                myPixels = new int[myWidth * myHeight];
                PixelGrabber pixelgrabber = new PixelGrabber(image, 0, 0, myWidth, myHeight, myPixels, 0, myWidth);
                pixelgrabber.grabPixels();
            } catch (Exception exception) {
            ...
            try {
                Image image = Toolkit.getDefaultToolkit().getImage(client.sign.Signlink.findCacheDIR() + "sprites/gameframe/pillarright.png");
                myPixels = new int[myWidth * myHeight];
                PixelGrabber pixelgrabber = new PixelGrabber(image, 0, 0, myWidth, myHeight, myPixels, 0, myWidth);
                pixelgrabber.grabPixels();
            } catch (Exception exception) {
            ...
            try {
                Image image = Toolkit.getDefaultToolkit().getImage(client.sign.Signlink.findCacheDIR() + "sprites/gameframe/topborder.png");
                myPixels = new int[myWidth * myHeight];
                PixelGrabber pixelgrabber = new PixelGrabber(image, 0, 0, myWidth, myHeight, myPixels, 0, myWidth);
                pixelgrabber.grabPixels();
            } catch (Exception exception) {
            ...
            try {
                Image image = Toolkit.getDefaultToolkit().getImage(client.sign.Signlink.findCacheDIR() + "sprites/gameframe/pillarlefttop.png");
                myPixels = new int[myWidth * myHeight];
                PixelGrabber pixelgrabber = new PixelGrabber(image, 0, 0, myWidth, myHeight, myPixels, 0, myWidth);
                pixelgrabber.grabPixels();
            } catch (Exception exception) {
            ...
            try {
                Image image = Toolkit.getDefaultToolkit().getImage(client.sign.Signlink.findCacheDIR() + "sprites/gameframe/pillarleftbottom.png");
                myWidth = 39;
                myHeight = 128;
                myPixels = new int[myWidth * myHeight];
                PixelGrabber pixelgrabber = new PixelGrabber(image, 0, 0, myWidth, myHeight, myPixels, 0, myWidth);
            ...
            try {
                Image image = Toolkit.getDefaultToolkit().getImage(client.sign.Signlink.findCacheDIR() + "sprites/gameframe/map1.png");
                myPixels = new int[myWidth * myHeight];
                PixelGrabber pixelgrabber = new PixelGrabber(image, 0, 0, myWidth, myHeight, myPixels, 0, myWidth);
                pixelgrabber.grabPixels();
            } catch (Exception exception) {
            ...
            try {
                Image image = Toolkit.getDefaultToolkit().getImage(client.sign.Signlink.findCacheDIR() + "sprites/tabicons/icon " + i + ".png");
                myWidth = 100;
                myHeight = 100;
                myPixels = new int[myWidth * myHeight];
                PixelGrabber pixelgrabber = new PixelGrabber(image, 0, 0, myWidth, myHeight, myPixels, 0, myWidth);
            ...
            try {
                Image image = Toolkit.getDefaultToolkit().getImage(client.sign.Signlink.findCacheDIR() + "sprites/" + s + " " + i + ".png");
                myWidth = 28;
                myHeight = 28;
                myPixels = new int[myWidth * myHeight];
                PixelGrabber pixelgrabber = new PixelGrabber(image, 0, 0, myWidth, myHeight, myPixels, 0, myWidth);
            ...
            try {
                Image image = Toolkit.getDefaultToolkit().getImage(client.sign.Signlink.findCacheDIR() + "sprites/gameframe/chatback.png");
                myWidth = 600;
                myHeight = 400;
                myPixels = new int[myWidth * myHeight];
                PixelGrabber pixelgrabber = new PixelGrabber(image, 0, 0, myWidth, myHeight, myPixels, 0, myWidth);
            ...
            try {
                Image image = Toolkit.getDefaultToolkit().getImage(client.sign.Signlink.findCacheDIR() + "sprites/gameframe/stones/n.png");
                myWidth = 100;
                myHeight = 100;
                myPixels = new int[myWidth * myHeight];
                PixelGrabber pixelgrabber = new PixelGrabber(image, 0, 0, myWidth, myHeight, myPixels, 0, myWidth);
            ...
            try {
                ...
                myHeight = 100;
                myPixels = new int[myWidth * myHeight];
                Image image = Toolkit.getDefaultToolkit().getImage(client.sign.Signlink.findCacheDIR() + "sprites/gameframe/stones/REDSTONE1 0.png");
                if (Client.flip) {
                    image = Toolkit.getDefaultToolkit().getImage(client.sign.Signlink.findCacheDIR() + "sprites/gameframe/stones/REDSTONE1 1.png");
                }
                if (Client.flip_s) {
                    image = Toolkit.getDefaultToolkit().getImage(client.sign.Signlink.findCacheDIR() + "sprites/gameframe/stones/REDSTONE1 2.png");
                }
                if (Client.flip_r) {
                    image = Toolkit.getDefaultToolkit().getImage(client.sign.Signlink.findCacheDIR() + "sprites/gameframe/stones/REDSTONE1 3.png");
                }
                PixelGrabber pixelgrabber = new PixelGrabber(image, 0, 0, myWidth, myHeight, myPixels, 0, myWidth);
                pixelgrabber.grabPixels();
            } catch (Exception exception) {
            ...
            try {
                Image image = Toolkit.getDefaultToolkit().getImage(client.sign.Signlink.findCacheDIR() + "sprites/gameframe/invback.png");
                myWidth = 192;
                myHeight = 261;
                myPixels = new int[myWidth * myHeight];
                PixelGrabber pixelgrabber = new PixelGrabber(image, 0, 0, myWidth, myHeight, myPixels, 0, myWidth);
            ...
            try {
                Image image = Toolkit.getDefaultToolkit().getImage(client.sign.Signlink.findCacheDIR() + "sprites/gameframe/compass.png");
                myPixels = new int[myWidth * myHeight];
                PixelGrabber pixelgrabber = new PixelGrabber(image, 0, 0, myWidth, myHeight, myPixels, 0, myWidth);
                pixelgrabber.grabPixels();
            } catch (Exception exception) {
            ...
            try {
                Image image = Toolkit.getDefaultToolkit().getImage(client.sign.Signlink.findCacheDIR() + "sprites/misc/mod " + i + ".png");
                myPixels = new int[myWidth * myHeight];
                PixelGrabber pixelgrabber = new PixelGrabber(image, 0, 0, myWidth, myHeight, myPixels, 0, myWidth);
                pixelgrabber.grabPixels();
            } catch (Exception exception) {
            ...
            try {
                Image image = Toolkit.getDefaultToolkit().getImage(client.sign.Signlink.findCacheDIR() + "sprites/borders/corners " + i + ".png");
                myPixels = new int[myWidth * myHeight];
                PixelGrabber pixelgrabber = new PixelGrabber(image, 0, 0, myWidth, myHeight, myPixels, 0, myWidth);
                pixelgrabber.grabPixels();
            } catch (Exception exception) {
            ...
            try {
                Image image = Toolkit.getDefaultToolkit().getImage(client.sign.Signlink.findCacheDIR() + "sprites/borders/topright " + i + ".png");
                myPixels = new int[myWidth * myHeight];
                PixelGrabber pixelgrabber = new PixelGrabber(image, 0, 0, myWidth, myHeight, myPixels, 0, myWidth);
                pixelgrabber.grabPixels();
            } catch (Exception exception) {
            ...
            try {
                Image image = Toolkit.getDefaultToolkit().getImage(client.sign.Signlink.findCacheDIR() + "sprites/borders/botleft " + i + ".png");
                myPixels = new int[myWidth * myHeight];
                PixelGrabber pixelgrabber = new PixelGrabber(image, 0, 0, myWidth, myHeight, myPixels, 0, myWidth);
                pixelgrabber.grabPixels();
            } catch (Exception exception) {
    ...
    public void method354(IndexedImage class30_sub2_sub1_sub2, int i, int j) {
        j += drawOffsetX;
        i += drawOffsetY;
        ...
        if (j1 <= 0 || i1 <= 0) {
            ...
            method355(myPixels, j1, class30_sub2_sub1_sub2.imgPixels, i1, DrawingArea.pixels, 0, k1, k, l1, l);
            return;
        }
    }
