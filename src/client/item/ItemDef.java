...
public final class ItemDef {
    ...
    public int id;
    public static MemCache mruNodes1 = new MemCache(100);
    ...
    public static final Sprite getSprite(int i, int j, int k, int l) {
        ...
        Model class30_sub2_sub4_sub6 = class8.getModelForAmount(1);
        ...
        class30_sub2_sub4_sub6.method482(0, class8.modelRotation2, class8.anInt204, class8.modelRotation1, class8.modelOffset1, l3 + ((Entity) (class30_sub2_sub4_sub6)).modelHeight / 2 + class8.modelOffset2, i4 + class8.modelOffset2);
    ...
    public final Model getModelForAmount(int i) {
