...
public class Model extends Mobile {
    ...
    public static ModelHeader modelHeaderCache[];
    public static OnDemandFetcherParent abstractODFetcher;
    public static boolean aBooleanArray1663[] = new boolean[4096];
    public static boolean aBooleanArray1664[] = new boolean[4096];
    public static int vertexSX[] = new int[4096];
    public static int vertexSY[] = new int[4096];
    public static int depthBuffer[] = new int[4096];
    public static int vertexMvX[] = new int[4096];
    public static int vertexMvY[] = new int[4096];
    public static int vertexMvZ[] = new int[4096];
    public static int depthListIndices[] = new int[1500];
    public static int faceLists[][] = new int[1500][512];
    ...
    public Model(boolean flag, int i, boolean flag1, Model class30_sub2_sub4_sub6) {
        ...
        if (flag1) {
            ...
            for (int j1 = 0; j1 < vertexCount; j1++) {
                VertexNormal class33 = super.vertexNormal[j1] = new VertexNormal();
                VertexNormal class33_1 = ((Entity) (class30_sub2_sub4_sub6)).vertexNormal[j1];
        ...
        triMIndex = class30_sub2_sub4_sub6.triMIndex;
        triNIndex = class30_sub2_sub4_sub6.triNIndex;
        super.modelHeight = ((Entity) (class30_sub2_sub4_sub6)).modelHeight;
    ...
    public final void light(int i, int j, int k, int l, int i1, boolean flag) {
        ...
        for (int i2 = 0; i2 < triangleCount; i2++) {
            ...
            if (triangleDrawType == null || (triangleDrawType[i2] & 1) == 0) {
                VertexNormal class33_2 = super.vertexNormal[j2];
                class33_2.anInt602 += l4;
                class33_2.anInt603 += i5;
                class33_2.anInt604 += j5;
                class33_2.anInt605++;
                class33_2 = super.vertexNormal[l2];
                class33_2.anInt602 += l4;
                class33_2.anInt603 += i5;
                class33_2.anInt604 += j5;
                class33_2.anInt605++;
                class33_2 = super.vertexNormal[i3];
                class33_2.anInt602 += l4;
                class33_2.anInt603 += i5;
                class33_2.anInt604 += j5;
                class33_2.anInt605++;
        ...
        if (flag) {
            ...
            for (int k2 = 0; k2 < vertexCount; k2++) {
                VertexNormal class33 = super.vertexNormal[k2];
    ...
    public final void method480(int i, int j, int k, int l, int i1) {
        for (int j1 = 0; j1 < triangleCount; j1++) {
            ...
            if (triangleDrawType == null) {
                ...
                VertexNormal class33_1 = super.vertexNormal[k1];
                ...
                class33_1 = super.vertexNormal[i2];
                ...
                class33_1 = super.vertexNormal[j2];
                l2 = i + (k * class33_1.anInt602 + l * class33_1.anInt603 + i1 * class33_1.anInt604) / (j * class33_1.anInt605);
