...
//        anInt664 = 201;
    ...
    private float calculateDigitalFrequency(float note) {
        // like angular velocity or some shit
    ...
    public final void method545(Stream stream, AmplitudeEnvelope amplitudeEnvelope) {
