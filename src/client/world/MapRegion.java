            ...
            for (int l6 = -5; l6 < anInt146 + 5; l6++) {
                for (int i8 = 0; i8 < anInt147; i8++) {
                    ...
                    if (k9 >= 0 && k9 < anInt146) {
                        ...
                        if (l12 > 0) {
                            Floor class22 = Floor.floorCache[l12 - 1];
                            anIntArray124[i8] += class22.hue2;
                    ...
                    if (i13 >= 0 && i13 < anInt146) {
                        ...
                        if (i14 > 0) {
                            Floor class22_1 = Floor.floorCache[i14 - 1];
                            anIntArray124[i8] -= class22_1.hue2;
                        ...
                        if (k17 >= 1 && k17 < anInt147 - 1 && (!lowMem || (aByteArrayArrayArray149[0][l6][k17] & 2) != 0 || (aByteArrayArrayArray149[l][l6][k17] & 0x10) == 0 && method182(k17, l, l6, 0) == anInt131)) {
                            ...
                            if (l18 > 0 || i19 > 0) {
                                ...
                                if (l > 0) {
                                    ...
                                    if (i19 > 0 && !Floor.floorCache[i19 - 1].occlude) {
                                        flag = false;
                                    }
                                ...
                                if (i19 == 0) {
                                    ...
                                    Floor class22_2 = Floor.floorCache[i19 - 1];
    ...
    private final void method175(int i, WorldController class25, TileSetting class11, int j, int k, int l, int i1,
        ...
        if (j == 10 || j == 11) {
            ...
            if (obj1 != null) {
                ...
                if (class25.method284(l2, k2, l4, ((Entity) (obj1)), j4, k, i5, (byte) 110, i, l) && class46.aBoolean779) {
                    Model class30_sub2_sub4_sub6;
                    if (obj1 instanceof Model) {
                        class30_sub2_sub4_sub6 = (Model) obj1;
                    } else {
                        class30_sub2_sub4_sub6 = class46.renderObject(10, j1, k1, l1, i2, j2, -1);
                    }
            ...
            if (class46.aBoolean767 && class11 != null) {
                class11.method212(class46.aBoolean757, class46.sizeX, class46.objectHeight, l, i, j1);
            }
            return;
        }
        if (j >= 12) {
            ...
            do {
                ...
                do {
                    ...
                    if (j3 == i && i3 >= i1 && i3 < i1 + 8 && l2 >= k && l2 < k + 8) {
                        ...
                        int j4 = j + Class4.method157(j1, class46.objectHeight, i3 & 7, l2 & 7, class46.sizeX);
                        int k4 = k1 + Class4.method158(l2 & 7, class46.objectHeight, j1, class46.sizeX, i3 & 7);
    ...
    public static void method188(WorldController class25, int i, int j, int k, int l, TileSetting class11, int ai[][][], int i1, int j1, int k1) {
        ...
        if (k == 10 || k == 11) {
            ...
            if (obj1 != null) {
                ...
                class25.method284(i3, l2, i5, ((Entity) (obj1)), k4, k1, j5, (byte) 110, j, i1);
            }
            if (class46.aBoolean767) {
                class11.method212(class46.aBoolean757, class46.sizeX, class46.objectHeight, i1, j, i);
            }
            return;
        }
        if (k >= 12) {
