...
public class MapFunctions extends DrawingArea {
    ...
    public MapFunctions(JagexArchive jagexAchive, String s, int i) {
        Stream class1_sub1_sub2 = new Stream(jagexAchive.getDataForName(s + ".dat"));
        Stream class1_sub1_sub2_1 = new Stream(jagexAchive.getDataForName("index.dat"));
