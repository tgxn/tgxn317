...
public class MapScenes extends DrawingArea {
	...
	public MapScenes(JagexArchive class6, String s, int i) {
		Stream byteVector = new Stream(class6.getDataForName(s + ".dat"));
		Stream byteVector_1 = new Stream(class6.getDataForName("index.dat"));
